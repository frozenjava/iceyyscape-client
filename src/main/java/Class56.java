...
public class Class56
{
	...
	try {
		...
		long l_2_ = l;
		l /= 37L;
		is[--i_0_] = Class81.aByteArray1496[(int) (l_2_ + -(l * 37L))];
	    }
	...
	if (Class68_Sub13_Sub10.anInt3595 != -1) {
	    anInt1061 = 0;
	    Class68_Sub20.method1004(0, 0, Class68_Sub13_Sub9.anInt3568, 0,
				     Class68_Sub13_Sub10.anInt3595, -1, 0,
				     Class13_Sub3.anInt2668, (byte) -112);
	}
	Class79.method1416();
	Class109.anInt1844 = 0;
    }
    
    public static boolean method572(Class21 class21, int i, int i_4_) {
	if (i != -1)
	    anInt1067 = -32;
	anInt1064++;
