...
public class Class68_Sub13_Sub17 extends Class68_Sub13
{
    ...
    public static int method783(int i, Class21 class21) {
	int i_16_ = 0;
	...
	class68_sub14.anInt2945 = class68_sub14.aByteArray2960.length - 2;
	int i_21_ = class68_sub14.readUnsignedWord(1355769544);
	int i_22_ = -2 + class68_sub14.aByteArray2960.length - (i_21_ - -12);
	...
	while ((class68_sub14.anInt2945 ^ 0xffffffff) > (i_22_ ^ 0xffffffff)) {
