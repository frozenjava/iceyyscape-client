...
public abstract class Class72
{
	...
	if (i != 0)
	    aClass16_1312 = null;
	int i_3_
	    = Class68_Sub20_Sub17.anInt4437 + -Class13_Sub3.anInt2668 + -i_1_;
	int i_4_ = -i_2_ + (Class21.anInt479 + -Class68_Sub13_Sub9.anInt3568);
	do {
		...
		try {
		    ...
		    if (i_1_ > 0)
			graphics.fillRect(i_6_, i_5_, i_1_, Class21.anInt479);
		    if (i_2_ > 0)
			...
			graphics.fillRect((i_6_ + Class68_Sub20_Sub17.anInt4437
					   + -i_3_),
					  i_5_, i_3_, Class21.anInt479);
		    if ((i_4_ ^ 0xffffffff) >= -1)
			break;
		    graphics.fillRect(i_6_, Class21.anInt479 + (i_5_ + -i_4_),
    ...
    public static Class21_Sub1 method1355
	(byte i, boolean bool, boolean bool_29_, int i_30_, boolean bool_31_) {
	...
	if (Class50.aStream_979 != null) {
	    Class50.aStream_979.anInt2945 = i_39_ * 8 - -5;
