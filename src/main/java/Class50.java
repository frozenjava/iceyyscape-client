...
public abstract class Class50
{
	...
	if (Class68_Sub25.aClass61_3167 != null) {
		...
		class68_sub14.writeByte(32, !bool ? 3 : 2);
		class68_sub14.method918(0, bool_1_);
		Class68_Sub25.aClass61_3167
		    .method590(0, (byte) 116, 4, class68_sub14.aByteArray2960);
	    } catch (java.io.IOException ioexception) {
		try {
		    Class68_Sub25.aClass61_3167.method594(-125);
	...
	for (;;) {
	    ...
	    if (bool_2_)
		break;
	    class68_sub14_sub1.createFrame(-53, i);
	    class68_sub14_sub1.writeByte(32, 0);
	    int i_4_ = class68_sub14_sub1.anInt2945;
	    class68_sub14_sub1.writeDWord(544537784, class68_sub9.anInt2897);
	    for (int i_5_ = 0;
		 (i_5_ ^ 0xffffffff) > (class68_sub9.anInt2884 ^ 0xffffffff);
		 i_5_++) {
		if (class68_sub9.anIntArray2888[i_5_] != 0)
		    class68_sub14_sub1
			.writeByte(32, class68_sub9.anIntArray2888[i_5_]);
		else {
		    try {
			...
			if ((i_6_ ^ 0xffffffff) == -1) {
			    ...
			    class68_sub14_sub1.writeByte(32, 0);
			    class68_sub14_sub1.writeDWord(544537784, i_7_);
			    ...
			    class68_sub14_sub1.writeByte(32, 0);
			    class68_sub14_sub1.writeDWord(544537784, i_8_);
			}
			if (i_6_ == 3) {
			    Method method
				...
				if (object instanceof Number) {
				    class68_sub14_sub1.writeByte(32, 1);
				    class68_sub14_sub1.method924
					(!bool, ((Number) object).longValue());
				} else if (!(object instanceof RSString))
				    class68_sub14_sub1.writeByte(32, 4);
				else {
				    class68_sub14_sub1.writeByte(32, 2);
				    class68_sub14_sub1.method914((byte) -9,
								 ((RSString)
								  object));
				}
			    } else
			    ...
			    class68_sub14_sub1.writeByte(32, 0);
			    class68_sub14_sub1.writeDWord(544537784, i_10_);
			}
		    } catch (ClassNotFoundException classnotfoundexception) {
			class68_sub14_sub1.writeByte(32, -10);
		    } catch (java.io.InvalidClassException invalidclassexception) {
			class68_sub14_sub1.writeByte(32, -11);
		    } catch (java.io.StreamCorruptedException streamcorruptedexception) {
			class68_sub14_sub1.writeByte(32, -12);
		    } catch (java.io.OptionalDataException optionaldataexception) {
			class68_sub14_sub1.writeByte(32, -13);
		    } catch (IllegalAccessException illegalaccessexception) {
			class68_sub14_sub1.writeByte(32, -14);
		    } catch (IllegalArgumentException illegalargumentexception) {
			class68_sub14_sub1.writeByte(32, -15);
		    } catch (java.lang.reflect.InvocationTargetException invocationtargetexception) {
			class68_sub14_sub1.writeByte(32, -16);
		    } catch (SecurityException securityexception) {
			class68_sub14_sub1.writeByte(32, -17);
		    } catch (java.io.IOException ioexception) {
			class68_sub14_sub1.writeByte(32, -18);
		    } catch (NullPointerException nullpointerexception) {
			class68_sub14_sub1.writeByte(32, -19);
		    } catch (Exception exception) {
			class68_sub14_sub1.writeByte(32, -20);
		    } catch (Throwable throwable) {
			class68_sub14_sub1.writeByte(32, -21);
		    }
		}
	    }
	    class68_sub14_sub1.method920(i_4_, -116);
	    class68_sub14_sub1.method935(class68_sub14_sub1.anInt2945 - i_4_,
					 124);
