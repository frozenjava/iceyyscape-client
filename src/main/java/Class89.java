...
public class Class89
{
	...
	Class81.anInt1493
	    = Class68_Sub26.anInt3186 + Class68_Sub20_Sub14.anInt4384;
	if (Class81.anInt1493 > Class97.anInt1714)
	    Class81.anInt1493 = Class97.anInt1714;
	int i_65_ = 3500;
	for (int i_66_ = 0;
	...
	for (int i_76_ = 0; i_76_ < Class68_Sub20_Sub16.anInt4418; i_76_++) {
	    ...
	    if ((i_78_ & 0x10) != 0) {
		class1_sub6_sub1.anInt2525 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(1355769544);
		...
		class1_sub6_sub1.aClass80_3395 = (Class68_Sub13_Sub11.method753(Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(119), 18));
		...
		if (class1_sub6_sub1.aClass80_3395.method1444(0))
		    Class52.method543(19395, class1_sub6_sub1.anIntArray2570[0], class1_sub6_sub1, null, 0, class1_sub6_sub1.anIntArray2523[0], Class61.anInt1149, null);
	    }
	    if ((0x40 & i_78_) != 0) {
		...
		class1_sub6_sub1.anInt2572 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    }
	    if ((0x4 & i_78_) != 0) {
