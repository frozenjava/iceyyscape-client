...
public class Class68_Sub13_Sub19 extends Class68_Sub13
{
		...
		if (Class29.anInt537 == 1) {
			...
			if (class93.aBoolean1661
				...
				= Class68_Sub20_Sub13_Sub2.method1166
				      (2,
				       new RSString[] { class93.aRSString_1670,(Class68_Sub20_Sub11.aRSString_4333) }).method1575((byte) -110);
			    Class68_Sub9.serverIP = new String(is, 0, is.length);
			    Class106.anInt1799 = class93.anInt1664;
			    if ((Class75_Sub3.connectionType ^ 0xffffffff) != -1) {
				Class68_Sub15.anInt3013 = 50000 + Class106.anInt1799;
				Class115.serverPort = Class106.anInt1799 + 40000;
    ...
    static {
	aRSString_3741 = Class112.method1668(43, "Welcome to iceyyscape!");
	aRSString_3740 = aRSString_3741;
	anInt3755 = 0;
	aRSString_3754 = Class112.method1668(43, "Loading)3)3)3");
	anInt3759 = 0;
