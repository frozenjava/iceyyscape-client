...
public class Class68_Sub13_Sub16 extends Class68_Sub13
{
    ...
    public static Class68_Sub20_Sub10[] method775(Class21 class21, int i,
	...
	do {
		...
		try {
			...
			graphics.fillRect(0, 0, Class13_Sub3.anInt2668,
			...
			if (Class89.anImage1622 == null)
			    Class89.anImage1622
				= Class86.aCanvas1585.createImage(304, 34);
			if (i_45_ != 23189)
			...
			graphics.drawImage(Class89.anImage1622,
					   Class13_Sub3.anInt2668 / 2 + -152,
					   (Class68_Sub13_Sub9.anInt3568 / 2
					    - 18),
					   null);
		    } catch (Exception exception) {
			int i_47_ = Class13_Sub3.anInt2668 / 2 + -152;
			int i_48_ = Class68_Sub13_Sub9.anInt3568 / 2 + -18;
			...
			((Class13_Sub3.anInt2668 / 2
			 ...
			 -26 + Class68_Sub13_Sub9.anInt3568 / 2, graphics,
			 i_45_ ^ ~0x5aad);
		} catch (Exception exception) {
