...
public class Class68_Sub13_Sub7 extends Class68_Sub13
{
    ...
    public static int method731(Class21 class21, int i, Class21 class21_4_) {
	try {
	    anInt3546++;
	    int i_5_ = 0;
	...
	if (i != 19114)
	    aRSString_3551 = null;
	while (Class68_Sub13_Sub8.aPacketStream_3560.method970(Class106.anInt1804, -104) >= 27) {
	    int i_8_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 15);
	    if (i_8_ == 32767)
		break;
	    boolean bool = false;
	    ...
	    class1_sub6_sub1.aClass80_3395 = Class68_Sub13_Sub11.method753(Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 14), -103);
	    ...
	    int i_10_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 5);
	    if (i_10_ > 15)
		i_10_ -= 32;
	    int i_11_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 5);
	    int i_12_ = (Class68_Sub13_Sub9.anIntArray3578[Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 3)]);
	    if (bool)
		class1_sub6_sub1.anInt2533 = class1_sub6_sub1.anInt2548
		    = i_12_;
	    if (i_11_ > 15)
		i_11_ -= 32;
	    int i_13_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
