...
public class Class68_Sub13_Sub24 extends Class68_Sub13
{
    ...
    public static Class21 aClass21_3831;
    ...
    public static Class21 aClass21_3843;
	...
	class68_sub14.anInt2945 = is.length - 2;
	...
	class68_sub14.anInt2945 = -7 + is.length - 8 * Stream.anInt3007;
	...
	if (Class72.anInt1321 >= 100) {
	    ...
	    int i_37_ = 64 + Class126.anInt2191 * 128;
	    int i_38_ = (Class1_Sub6_Sub2.method163(i_36_, Class61.anInt1149,
						    i_37_, false)
