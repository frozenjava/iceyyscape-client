...
public class Class68_Sub13_Sub18 extends Class68_Sub13
{
	...
	if (Class13_Sub3.anInt2668 < i_18_ + i_21_)
	    i_21_ = Class13_Sub3.anInt2668 - i_18_;
	int i_22_ = 21 + 15 * Class68_Sub13_Sub21.anInt3803;
	if (i_21_ < 0)
	    i_21_ = 0;
	int i_23_ = Class92.anInt1646;
	anInt3726++;
	if ((Class68_Sub13_Sub9.anInt3568 ^ 0xffffffff)
	    > (i_22_ + i_23_ ^ 0xffffffff))
	    i_23_ = -i_22_ + Class68_Sub13_Sub9.anInt3568;
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -249) {
	    ...
	    int i_34_ = Class68_Sub13_Sub8.aPacketStream_3560
		...
		Class1_Sub5 class1_sub5
		    = (new Class1_Sub5
		       (i_34_, Class61.anInt1149, i_32_, i_33_,
	    ...
	    int i_40_ = i_39_ + Class68_Sub13_Sub8.aPacketStream_3560
				    .method955(i + 3391);
	    int i_41_ = i_38_ + Class68_Sub13_Sub8.aPacketStream_3560
				    .method955(3390);
	    int i_42_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .method957(-22489);
	    int i_43_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .readUnsignedWord(1355769544);
	    int i_44_ = 4 * Class68_Sub13_Sub8.aPacketStream_3560
				.readUnsignedByte(-6677);
	    int i_45_ = (Class68_Sub13_Sub8.aPacketStream_3560
	    ...
	    int i_47_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .readUnsignedWord(1355769544);
	    int i_48_ = Class68_Sub13_Sub8.aPacketStream_3560
		...
		Class1_Sub1 class1_sub1
		    = (new Class1_Sub1
		       (i_43_, Class61.anInt1149, i_39_, i_38_,
	    ...
	    int i_51_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteA();
	    int i_52_ = Class68_Sub28_Sub1.anInt4491 + (0x7 & i_51_);
	    int i_53_ = Class93.anInt1668 + (0x7 & i_51_ >> -1355904828);
	    int i_54_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
		...
		Class89.method1500(i_53_, i ^ 0xffffffff, -1, i_56_, i_52_,
				   i_55_, i_57_, Class61.anInt1149, 0, i_50_);
	} else if (Class49.anInt962 == 110) {
	    int i_58_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	    int i_59_ = i_58_ >> -1965788638;
	    int i_60_ = i_58_ & 0x3;
	    int i_61_ = Class12.anIntArray201[i_59_];
	    int i_62_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    int i_63_
	    ...
	    Class43.method483(i_64_, i_59_, Class61.anInt1149, i_60_, i_65_,
	    ...
	    int i_69_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .readUnsignedWord(1355769544);
	    if ((i_69_ ^ 0xffffffff) == -65536)
		i_69_ = -1;
	    int i_70_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    int i_71_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .readUnsignedByte(i + -6676);
	    ...
	    int i_75_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    int i_76_ = ((i_75_ & 0x73) >> 177348356) + Class93.anInt1668;
	    int i_77_ = (i_75_ & 0x7) + Class68_Sub28_Sub1.anInt4491;
	    int i_78_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(1355769544);
	    if (i_76_ >= 0 && i_77_ >= 0 && i_76_ < 104 && (i_77_ ^ 0xffffffff) > -105) {
		Class16 class16 = (Class45.aClass16ArrayArrayArray926[Class61.anInt1149][i_76_][i_77_]);
		if (class16 != null) {
			...
			Class45.aClass16ArrayArrayArray926[Class61.anInt1149][i_76_][i_77_] = null;
		    Class68_Sub20_Sub9.method1100(i_76_, (byte) -52, i_77_);
		}
	    }
	} else {
	    if ((Class49.anInt962 ^ 0xffffffff) == -22) {
		int i_79_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteA();
		int i_80_ = i_79_ & 0x3;
		int i_81_ = i_79_ >> -1321675038;
		int i_82_ = Class12.anIntArray201[i_81_];
		int i_83_ = Class68_Sub13_Sub8.aPacketStream_3560
				.method955(3390);
		int i_84_ = Class68_Sub13_Sub8.aPacketStream_3560
				.method919((byte) 88);
		int i_85_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
		int i_86_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
		int i_87_ = Class68_Sub13_Sub8.aPacketStream_3560
				.readUnsignedWord(1355769544);
		int i_88_ = Class68_Sub13_Sub8.aPacketStream_3560
				.readUnsignedByte(-6677);
		int i_89_ = Class93.anInt1668 - -(0x7 & i_88_ >> -1932319804);
		int i_90_ = Class68_Sub28_Sub1.anInt4491 - -(0x7 & i_88_);
		int i_91_ = Class68_Sub13_Sub8.aPacketStream_3560
				.method919((byte) 59);
		int i_92_ = Class68_Sub13_Sub8.aPacketStream_3560
				.readUnsignedWordBigEndian(-41);
		int i_93_ = Class68_Sub13_Sub8.aPacketStream_3560
				.method917(false);
		...
		int i_106_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
		int i_107_ = (0x7 & i_106_) + Class68_Sub28_Sub1.anInt4491;
		int i_108_
		    = ((i_106_ & 0x76) >> 742230052) + Class93.anInt1668;
		int i_109_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
		...
		if ((Class49.anInt962 ^ 0xffffffff) == -113) {
		    ...
		    int i_117_ = (Class68_Sub13_Sub8
				      .aPacketStream_3560.method955(3390)
				  + i_115_);
		    ...
		    int i_119_ = Class68_Sub13_Sub8
				     ...
				     .readUnsignedWord(1355769544);
		    int i_120_
			= 4 * Class68_Sub13_Sub8.aPacketStream_3560
				  .readUnsignedByte(-6677);
		    int i_121_
			= 4 * Class68_Sub13_Sub8.aPacketStream_3560
				  .readUnsignedByte(-6677);
			...
			Class1_Sub1 class1_sub1
			    = (new Class1_Sub1
			       (i_119_, Class61.anInt1149, i_114_, i_115_,
		    ...
		    int i_126_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
		    ...
		    int i_128_ = Class68_Sub13_Sub8
				     .aPacketStream_3560
				     .readUnsignedWord(1355769544);
		    int i_129_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
			...
			if ((Class45.aClass16ArrayArrayArray926
			     [Class61.anInt1149][i_131_][i_130_])
			    == null)
			    Class45.aClass16ArrayArrayArray926
				[Class61.anInt1149][i_131_][i_130_]
				= new Class16();
			Class45.aClass16ArrayArrayArray926
			    [Class61.anInt1149][i_131_][i_130_].method286
			    (new Class68_Sub20_Sub18(class1_sub2), true);
			Class68_Sub20_Sub9.method1100(i_131_, (byte) -52,
						      i_130_);
		    }
		} else if (Class49.anInt962 == 25) {
		    int i_132_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
		    int i_133_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
		    int i_134_ = (0x7 & i_133_ >> 2071123620) + Class93.anInt1668;
		    int i_135_ = Class68_Sub28_Sub1.anInt4491 + (i_133_ & 0x7);
		    int i_136_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
			...
			if ((Class45.aClass16ArrayArrayArray926[Class61.anInt1149][i_134_][i_135_]) == null)
			    Class45.aClass16ArrayArrayArray926[Class61.anInt1149][i_134_][i_135_] = new Class16();
			Class45.aClass16ArrayArrayArray926[Class61.anInt1149][i_134_][i_135_].method286(new Class68_Sub20_Sub18(class1_sub2), true);
			...
			Class16 class16
			    = (Class45.aClass16ArrayArrayArray926
			       [Class61.anInt1149][i_139_][i_138_]);
			if (class16 != null) {
    ...
    public static Class92_Sub1 method791(Class21 class21, byte i, int i_143_,
					 int i_144_) {
	anInt3735++;
	if (i != 66)
	    return null;
	if (!Class68_Sub13_Sub36.method880(-29381, i_143_, class21, i_144_))
	    return null;
	return Class38.method460(i ^ 0x25fc);
    }
