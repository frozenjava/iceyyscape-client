...
public abstract class Class105
{
    ...
    public static void method1643(Class21 class21, Class21 class21_0_, int i) {
	try {
	...
	if ((SignLink.aString1036.toLowerCase().indexOf("microsoft")
	     ^ 0xffffffff)
	    != 0) {
