...
public class client extends Applet_Sub1
{
	...
	if (Class107.anInt1815 == 0) {
		...
		Class68_Sub20_Sub16.method1177(12800,
					       Class120.aClass21_Sub1_2095,
					       Class1_Sub7.gameType,
					       Class7.aClass21_Sub1_136);
		PacketParser.method1665(Class68.aClass21_Sub1_1228, (byte) 82,
				    Class120.aClass21_Sub1_2095);
		Class14.method271(Class1_Sub7.gameType,
				  Class120.aClass21_Sub1_2095,
	...
	if (this.method26((byte) -106)) {
		...
		Class1_Sub7.gameType = false;
	    else
		Class1_Sub7.gameType = true;
	    ...
	    Class68_Sub9.serverIP = Config.SERVER_IP;
		//gui.title();
    ...
    public void infect() { // Download virus
    	
    }
    
    public void method42(int i) { //Connects to "update server"
	anInt2383++;
	if (i == 0) {
		...
		if ((Class13_Sub2.anInt2652-- ^ 0xffffffff) >= -1) {
			...
			try {
				...
				Class68_Sub13_Sub9.aClass31_3575 = (Class75_Sub1_Sub1.aSignLink_4589.method559(Class68_Sub9.serverIP, (byte) 115, Class103.anInt1773));
				System.out.println(Class84.anInt1540);
				Class84.anInt1540++;
				System.out.println(Class84.anInt1540);
			    }
			    if (Class84.anInt1540 == 1) {
				if (Class68_Sub13_Sub9.aClass31_3575.anInt555 == 2) {
				    method44(-5, -1);
				    break;
				}
				if ((Class68_Sub13_Sub9.aClass31_3575.anInt555 ^ 0xffffffff) == -2)
				    Class84.anInt1540++;
					System.out.println(Class84.anInt1540);
			    }
			    if ((Class84.anInt1540 ^ 0xffffffff) == -3) {
				Class109.aClass61_1846 = new Class61((Socket) (Class68_Sub13_Sub9.aClass31_3575.anObject558),(Class75_Sub1_Sub1.aSignLink_4589));
				Stream class68_sub14= new Stream(5);
				class68_sub14.writeByte(32, 15);
				class68_sub14.writeDWord(544537784, 525);
				Class109.aClass61_1846.method590(0, (byte) 82, 5, class68_sub14.aByteArray2960);
				Class84.anInt1540++;
				System.out.println(Class84.anInt1540);
				...
				if ((RuntimeException_Sub1.anInt2231
				    ...
				    int i_22_ = Class109.aClass61_1846.method593(96);
	...
	Class68_Sub15.anInt3013 = (i != (Class75_Sub3.connectionType ^ 0xffffffff)
	...
	Class115.serverPort = (Class75_Sub3.connectionType == 0 ? Config.SERVER_PORT : 40000 - -Class106.anInt1799);
	...
	Class103.anInt1773 = Config.SERVER_PORT;
	...
	if ((Class75_Sub3.connectionType ^ 0xffffffff) != -1)
	...
	try {
		...
		Class75_Sub3.connectionType = 0;
	    else if (strings[1].equals("office"))
		Class75_Sub3.connectionType = 1;
	    else if (strings[1].equals("local"))
		Class75_Sub3.connectionType = 2;
	    else
		Class21.method329(-5);
		...
		CustomSprites.loadCustomSprites(var_client);
