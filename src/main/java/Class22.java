...
public abstract class Class22
{
	...
	Class68_Sub13_Sub8.aPacketStream_3560.method965(122);
	anInt487++;
	int i_0_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 8);
	...
	for (/**/; (i_2_ ^ 0xffffffff) > (i_0_ ^ 0xffffffff); i_2_++) {
	    ...
	    int i_5_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
	    if (i_5_ == 0) {
		Class68_Sub10.anIntArray2906[Class13_Sub2.anInt2645++] = i_4_;
		class1_sub6_sub1.anInt2575 = Class68_Sub3.anInt2812;
	    } else {
		int i_6_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 2);
		if (i_6_ == 0) {
		    Class68_Sub10.anIntArray2906[Class13_Sub2.anInt2645++] = i_4_;
		    class1_sub6_sub1.anInt2575 = Class68_Sub3.anInt2812;
		    ...
		    int i_8_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
		    if (i_8_ == 1)
			PacketStream.anIntArray4110[Class68_Sub20_Sub16.anInt4418++] = i_4_;
		} else if (i_6_ == 2) {
		    Class68_Sub10.anIntArray2906[Class13_Sub2.anInt2645++] = i_4_;
		    class1_sub6_sub1.anInt2575 = Class68_Sub3.anInt2812;
		    int i_9_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 3);
		    class1_sub6_sub1.method151(true, i_9_, (byte) 21);
		    int i_10_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 3);
    ...
    public static void method374(byte i, Class21 class21) {
	if (i != 58)
