...
public class Class20
{
	...
	Class3.anInt87++;
	anInt420++;
	Class21.aPacketStream_466.createFrame(-67, 108);
    ...
    public static void method321(Class21 class21, byte i, Class21 class21_0_) {
	try {
	...
	class68_sub14.method942(24, (byte) 118, 0, is);
    }
	...
	if (bool == true) {
		...
		if (l != l_16_) {
			...
			&& Class86.method1486(Class61.anInt1149, i_17_, i_18_,
					      l_16_)) {
	...
	for (int i_42_ = Class47.anInt944; i_42_ < Class86.anInt1582;
	    ...
	    for (int i_43_ = Class69.anInt1239; i_43_ < Class30.anInt549;
		 i_43_++) {
		for (int i_44_ = Class85.anInt1557; i_44_ < Class81.anInt1493;
		     i_44_++) {
