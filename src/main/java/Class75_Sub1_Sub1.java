...
public class Class75_Sub1_Sub1 extends Class75_Sub1
{
    ...
    public static Class21 aClass21_4586;
    ...
    public static Class21 aClass21_4591;
	...
	anInt4576++;
	if (Class68_Sub20.aByteArrayArrayArray3095[Class61.anInt1149][i_0_][i]
	    == i_3_)
	    return false;
	if ((Class64.aByteArrayArrayArray1178[Class61.anInt1149][i_0_][i] & 0x4
	     ^ 0xffffffff)
	    == -1)
	    return false;
	int i_4_ = 0;
	...
	Class68_Sub20.aByteArrayArrayArray3095[Class61.anInt1149][i_0_][i]
	    = i_3_;
	while ((i_6_ ^ 0xffffffff) != (i_4_ ^ 0xffffffff)) {
	    ...
	    i_6_ = i_6_ + 1 & 0xfff;
	    if ((0x4 & (Class64.aByteArrayArrayArray1178[Class61.anInt1149]
			[i_8_][i_10_])
		 ^ 0xffffffff)
		== -1)
		bool_12_ = true;
	...
	while_144_:
	    for (int i_14_ = Class61.anInt1149 - -1;
		...
		if ((i_8_ ^ 0xffffffff) <= -2
			...
			[Class61.anInt1149][i_8_ + -1][i_10_]) != i_3_) {
		    ...
		    i_4_ = 1 + i_4_ & 0xfff;
		    Class68_Sub20.aByteArrayArrayArray3095
			[Class61.anInt1149][i_8_ + -1][i_10_]
			= i_3_;
		}
		if ((++i_10_ ^ 0xffffffff) > -105) {
			...
			&& ((Class64.aByteArrayArrayArray1178
			     [Class61.anInt1149][i_8_][i_10_]) & 0x4
			    ^ 0xffffffff) == -1
			&& ((Class64.aByteArrayArrayArray1178
			     [Class61.anInt1149][-1 + i_8_][i_10_ - 1])
			    & 0x4) == 0) {
			Class68_Sub13_Sub37.anIntArray4066[i_4_]
			    = Class70.method1335(Class70.method1335(1179648,
								    i_8_ + -1),
			...
			&& (0x4 & (Class64.aByteArrayArrayArray1178
				   [Class61.anInt1149][i_8_][i_10_])) == 0
			&& (0x4 & (Class64.aByteArrayArrayArray1178
				   [Class61.anInt1149][1 + i_8_][i_10_ - 1])
			    ^ 0xffffffff) == -1) {
			Class68_Sub13_Sub37.anIntArray4066[i_4_]
		...
		if ((i_8_ - -1 ^ 0xffffffff) > -105
		    && (Class68_Sub20.aByteArrayArrayArray3095
			[Class61.anInt1149][1 + i_8_][i_10_]) != i_3_) {
		    Class68_Sub13_Sub37.anIntArray4066[i_4_]
		...
		if (--i_10_ >= 0) {
			...
			&& ((Class64.aByteArrayArrayArray1178
			    ...
			    & 0x4) == 0
			&& (0x4 & (Class64.aByteArrayArrayArray1178
				   [Class61.anInt1149][i_8_ + -1][i_10_ + 1])
			    ^ 0xffffffff) == -1) {
			Class68_Sub13_Sub37.anIntArray4066[i_4_]
			...
			&& (0x4 & (Class64.aByteArrayArrayArray1178
			    ...
			    ^ 0xffffffff) == -1
			&& ((Class64.aByteArrayArrayArray1178
			     [Class61.anInt1149][1 + i_8_][1 + i_10_]) & 0x4
			    ^ 0xffffffff) == -1) {
			Class68_Sub13_Sub37.anIntArray4066[i_4_]
	...
	if (Class21_Sub1.anIntArray2693[i_1_] != -1000000) {
	    ...
	    Class126.anIntArray2180[i_1_] -= 50;
	...
	while ((class68_sub14.aByteArray2960.length ^ 0xffffffff)
	       < (class68_sub14.anInt2945 ^ 0xffffffff)) {
	    int i_29_ = 0;
	    int i_30_ = 0;
	    boolean bool = false;
		...
		if (bool)
		    class68_sub14.anInt2945 += 64;
		else
		    class68_sub14.anInt2945 += 4096;
	    } else {
