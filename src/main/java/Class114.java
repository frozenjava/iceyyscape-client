...
public class Class114
{
	...
	try {
	    anInt1935++;
	    if ((class68_sub14.aByteArray2960[class68_sub14.anInt2945]
		 ^ 0xffffffff) != -32
		|| (class68_sub14.aByteArray2960[1 + class68_sub14.anInt2945]
		    ^ 0xffffffff) != 116)
		throw new RuntimeException("Invalid GZIP header!");
	    if (anInflater1924 == null)
		anInflater1924 = new Inflater(true);
	    try {
		anInflater1924.setInput(class68_sub14.aByteArray2960,
					class68_sub14.anInt2945 + 10,
					(-class68_sub14.anInt2945
					 - (10
					    - (-8
					       + (class68_sub14
						  .aByteArray2960).length))));
    ...
    public static void method1690(byte i, boolean bool, Class38[] class38s) {
	anInt1931++;
	if (i != -111)
	    method1689(true);
	int i_0_;
	...
	for (int i_8_ = 0; i_8_ < i_0_; i_8_++) {
	    byte[][] is_9_ = Class38.aByteArrayArrayArray676[i_8_];
	    ...
	    Class38.aByteArrayArrayArray676[i_8_] = null;
	}
	...
	int i_104_ = (Class1_Sub6_Sub2.method163(i_102_, Class61.anInt1149,
						 i_103_, false)
	...
	i_103_ = 64 + 128 * Class126.anInt2191;
	i_102_ = 64 + 128 * Class8.anInt161;
	i_104_ = Class1_Sub6_Sub2.method163(i_102_, Class61.anInt1149, i_103_,
	...
	if (!Class28.method398(i ^ 0x60cd)
	    && ((Class61.anInt1149 ^ 0xffffffff)
		!= (Class68_Sub13_Sub18.anInt3737 ^ 0xffffffff)))
	    Class81.method1455((byte) -128,
			       (Class68_Sub7.aClass1_Sub6_Sub2_2860
				.anIntArray2570[0]),
			       Class61.anInt1149, false,
			       (Class68_Sub7.aClass1_Sub6_Sub2_2860
				.anIntArray2523[0]),
			       ItemDef.anInt365, Class43.anInt732);
	else if (Class68_Sub13_Sub32.anInt3981 != Class61.anInt1149) {
	    Class68_Sub13_Sub32.anInt3981 = Class61.anInt1149;
	    Class13_Sub1.method246((byte) -124, Class61.anInt1149);
	    Class107.method1654(i + -13401);
	}
    }
    
    public static void method1693(byte i, Class21 class21) {
