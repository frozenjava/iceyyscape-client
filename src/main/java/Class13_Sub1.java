...
public class Class13_Sub1 extends Class13
{
	...
	if (Class61.aClass68_Sub20_Sub10_1144 == null)
	    class68_sub20_sub10_sub1 = new Class68_Sub20_Sub10_Sub1(512, 512);
	else
	    class68_sub20_sub10_sub1
		= (Class68_Sub20_Sub10_Sub1) Class61.aClass68_Sub20_Sub10_1144;
	anInt2625++;
	...
	for (int i_10_ = 0; (i_10_ ^ 0xffffffff) > -105; i_10_++) {
		...
		long l = Class89.method1506(Class61.anInt1149, i_10_, i_11_);
		if (l != 0L) {
		    Class116 class116
			...
			if (i_12_ != 22 && i_12_ != 29
				...
				= (Class109.aClass38Array1843
				   [Class61.anInt1149].anIntArrayArray681);
	...
	Class61.aClass68_Sub20_Sub10_1144 = class68_sub20_sub10_sub1;
    ...
    public static Class92[] method248(Class21 class21, int i, boolean bool,
				      int i_27_) {
	anInt2622++;
	if (bool != false)
	...
	if ((RuntimeException_Sub1.anInt2231 ^ 0xffffffff) == -31
		...
		if (!Class75_Sub3_Sub1.aBoolean4597
		    ...
		    Class21.aPacketStream_466.createFrame(-53, 115);
		    try {
			Class126.aClass61_2190.method590(0, (byte) 33, Class21.aPacketStream_466.anInt2945, Class21.aPacketStream_466.aByteArray2960);
