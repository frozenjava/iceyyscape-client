...
public class Class61 implements Runnable
{
    ...
    public void method590(int i, byte i_0_, int i_1_, byte[] is)
	throws IOException {
	anInt1150++;
	if (!aBoolean1132) {
	    if (aBoolean1118) {
	    ...
	    if (i_0_ >= 23) {
		if (aByteArray1145 == null)
		    aByteArray1145 = new byte[5000];
		synchronized (this) {
		    for (int i_2_ = 0;
			 (i_2_ ^ 0xffffffff) > (i_1_ ^ 0xffffffff); i_2_++) {
			aByteArray1145[anInt1134] = is[i_2_ + i];
			anInt1134 = (1 + anInt1134) % 5000;
			if (((anInt1124 - -4900) % 5000 ^ 0xffffffff)
			    == (anInt1134 ^ 0xffffffff))
			    throw new IOException();
		    }
		    if (aClass31_1121 == null)
			aClass31_1121
			    = aSignLink_1131.method558((byte) -89, 3, this);
		    this.notifyAll();
		}
	    }
	}
	...
	try {
		...
		synchronized (this) {
		    ...
		    i = anInt1124;
		    if ((anInt1134 ^ 0xffffffff) > (anInt1124 ^ 0xffffffff))
			i_3_ = -anInt1124 + 5000;
		    else
			i_3_ = -anInt1124 + anInt1134;
		}
		if ((i_3_ ^ 0xffffffff) < -1) {
		    try {
			anOutputStream1130.write(aByteArray1145, i, i_3_);
		    } catch (IOException ioexception) {
			aBoolean1118 = true;
		    }
		    anInt1124 = (i_3_ + anInt1124) % 5000;
		    try {
			if (anInt1134 == anInt1124)
			    anOutputStream1130.flush();
		    } catch (IOException ioexception) {
			aBoolean1118 = true;
		    }
		}
	    ...
	    try {
		if (anInputStream1127 != null)
		    anInputStream1127.close();
		if (anOutputStream1130 != null)
		    anOutputStream1130.close();
		if (aSocket1123 != null)
		    aSocket1123.close();
	    } catch (IOException ioexception) {
		/* empty */
    ...
    public void method591(int i, int i_4_, int i_5_, byte[] is)
	throws IOException {
	anInt1140++;
	int i_6_ = 74 % ((i - 47) / 41);
	if (!aBoolean1132) {
	    while (i_4_ > 0) {
		int i_7_ = anInputStream1127.read(is, i_5_, i_4_);
    ...
    public static void method592(int i, Class21 class21) {
	anInt1133++;
	Class104.aClass92_Sub1Array1779
	    = Class13_Sub2.method256(class21, Class68_Sub20.anInt3089, 0,
				     -122);
	Class112.aClass92_Sub1Array1886
	    = new Class92_Sub1[Class104.aClass92_Sub1Array1779.length];
	Class68_Sub13_Sub19.aClass92_Sub1Array3745
	    = new Class92_Sub1[Class104.aClass92_Sub1Array1779.length];
	Class68_Sub20_Sub17.aClass92_Sub1Array4431
	    = new Class92_Sub1[Class104.aClass92_Sub1Array1779.length];
	for (int i_8_ = 0;
	     ((Class104.aClass92_Sub1Array1779.length ^ 0xffffffff)
	      < (i_8_ ^ 0xffffffff));
	     i_8_++) {
	    Class104.aClass92_Sub1Array1779[i_8_].method1532();
	    Class112.aClass92_Sub1Array1886[i_8_]
		= Class104.aClass92_Sub1Array1779[i_8_].method1535();
	    Class104.aClass92_Sub1Array1779[i_8_].method1532();
	    Class68_Sub13_Sub19.aClass92_Sub1Array3745[i_8_]
		= Class104.aClass92_Sub1Array1779[i_8_].method1535();
	    Class104.aClass92_Sub1Array1779[i_8_].method1532();
	    Class68_Sub20_Sub17.aClass92_Sub1Array4431[i_8_]
		= Class104.aClass92_Sub1Array1779[i_8_].method1535();
	    Class104.aClass92_Sub1Array1779[i_8_].method1532();
	}
	Stream.aClass68_Sub20_Sub10_Sub1Array3006
	    = Class81.method1461(false, Class68_Sub26.anInt3182, 0, class21);
	Class68_Sub13_Sub23.aClass68_Sub20_Sub10Array3821
	    = Class127.method1780(0, Class51.anInt2259, 0, class21);
	Class68_Sub16.aClass68_Sub20_Sub10Array3030
	    = Class127.method1780(0, Class17.anInt280, 0, class21);
	Class59.aClass68_Sub20_Sub10Array1106
	    = Class127.method1780(i + -12339, Class68_Sub13_Sub16.anInt3695, 0,
				  class21);
	Class108.aClass68_Sub20_Sub10Array1828
	    = Class127.method1780(0, Class113.anInt1902, 0, class21);
	Class68_Sub13_Sub12.aClass68_Sub20_Sub10Array3646
	    = Class68_Sub13_Sub16.method775(class21, 0, Class1_Sub5.anInt2500,
					    (byte) 13);
	Class70.aClass68_Sub20_Sub10Array1286
	    = Class68_Sub13_Sub16.method775(class21, 0, Class68_Sub8.anInt2876,
					    (byte) 13);
	Class68_Sub20_Sub17.aClass68_Sub20_Sub10_4440
	    = Class119.method1736(i + -12275, Applet_Sub1.anInt16, 0, class21);
	Class75_Sub2.aClass68_Sub20_Sub10Array3310
	    = Class68_Sub13_Sub16.method775(class21, 0,
					    Class68_Sub13_Sub38.anInt4082,
					    (byte) 13);
	Class112.aClass68_Sub20_Sub10Array1883
	    = Class68_Sub13_Sub16.method775(class21, 0,
					    Class68_Sub13_Sub27.anInt3891,
					    (byte) 13);
	Class68_Sub13_Sub23.aClass92Array3825
	    = Class13_Sub1.method248(class21, 0, false,
				     Class68_Sub20_Sub14.anInt4378);
	if (i == 12339) {
	    Stream.aClass92Array3010
		= Class13_Sub1.method248(class21, 0, false, Class15.anInt252);
	    Class68_Sub13_Sub21.aClass68_Sub20_Sub1_3801
		.method1017(Stream.aClass92Array3010, null);
		...
		= Class68_Sub22.method1202(Class97.anInt1712, (byte) -96,
					   class21, 0);
		...
		= Class81.method1461(false, Class97.anInt1706, 0, class21);
	    for (int i_9_ = 0; ((class68_sub20_sub10_sub1s.length ^ 0xffffffff)
	    ...
	    for (int i_14_ = 0;
		 (Stream.aClass68_Sub20_Sub10_Sub1Array3006.length
		  > i_14_);
		 i_14_++)
		Stream.aClass68_Sub20_Sub10_Sub1Array3006[i_14_]
		    .method1130(i_10_ + i_13_, i_11_ + i_13_, i_13_ + i_12_);
	    Class104.aClass92_Sub1Array1779[0]
		.method1533(i_10_ + i_13_, i_13_ + i_11_, i_12_ + i_13_);
	    Class68_Sub13_Sub11.aClass68_Sub20_Sub10Array3605
		= Stream.aClass68_Sub20_Sub10_Sub1Array3006;
	}
    }
    
    public int method593(int i) throws IOException {
	anInt1125++;
	if (aBoolean1132)
	    return 0;
        int read = anInputStream1127.read();
	return read;
    }
	...
	if (!aBoolean1132) {
		...
		if (aClass31_1121.anInt555 == 1) {
		    try {
			((Thread) aClass31_1121.anObject558).join();
		    } catch (InterruptedException interruptedexception) {
			/* empty */
		    }
		}
    ...
    public int method597(byte i) throws IOException {
	anInt1129++;
	if (i != 102)
	    method595(53, 70, 102, -56, 118);
	if (aBoolean1132)
	    return 0;
	return anInputStream1127.available();
    }
	...
	for (int i_21_ = 0;
	     ((i_21_ ^ 0xffffffff)
	      > (Class23.aByteArrayArray490.length ^ 0xffffffff));
	     i_21_++) {
	    if ((Class96.anIntArray1699[i_21_] ^ 0xffffffff) != 0
		&& Class23.aByteArrayArray490[i_21_] == null) {
		Class23.aByteArrayArray490[i_21_]
		    = Class92.aClass21_Sub1_1644
			  .method338(0, 0, Class96.anIntArray1699[i_21_]);
		...
		Class68_Sub20_Sub11.aByteArrayArray4332[i_21_]
		    = (Class92.aClass21_Sub1_1644.method350
		       (Class68_Sub20_Sub6.anIntArrayArray4246[i_21_],
	    ...
	    if (Class80.anIntArray1406 != null
		&& Class7.aByteArrayArray133[i_21_] == null
		&& (Class80.anIntArray1406[i_21_] ^ 0xffffffff) != 0) {
		Class7.aByteArrayArray133[i_21_]
		    = (Class92.aClass21_Sub1_1644.method350
		       (Class68_Sub20_Sub6.anIntArrayArray4246[i_21_],
	...
	if (Class97.aClass68_Sub20_Sub16_1702 == null
	    || !(Class68_Sub20_Sub5.aClass21_Sub1_4221.method347
		 ((byte) -101,
		  (Class68_Sub20_Sub13_Sub2.method1166
		   (2, (new RSString[]
			{ Class97.aClass68_Sub20_Sub16_1702.aRSString_4412,
			  Class71.aRSString_1296 }))))))
	    Class68_Sub13_Sub21.aClass91_3788 = null;
	else if (!Class68_Sub20_Sub5.aClass21_Sub1_4221.method354
		  (0, (Class68_Sub20_Sub13_Sub2.method1166
		       (2, (new RSString[]
			    { Class97.aClass68_Sub20_Sub16_1702.aRSString_4412,
			      Class71.aRSString_1296 }))))) {
	    Class68_Sub13_Sub19.anInt3748++;
	...
	if (!bool)
		...
		if (is != null) {
		    int i_23_
			= -Class36.anInt643 + (Class119.anIntArray2089[i_22_]
					       >> -1503568216) * 64;
		    int i_24_
			= (-Class68_Sub13_Sub35.anInt4026
			   + (0xff & Class119.anIntArray2089[i_22_]) * 64);
		...
		for (int i_26_ = 0; i_26_ < 4; i_26_++) {
			...
			for (int i_28_ = 0; i_28_ < 104; i_28_++)
			    Class64.aByteArrayArrayArray1178[i_26_][i_27_]
				[i_28_]
				= (byte) 0;
		    }
		}
		...
		PacketStream.method971(137);
		if (Class108.aFrame1832 != null && Class126.aClass61_2190 != null && RuntimeException_Sub1.anInt2231 == 25) {
		    Class21.aPacketStream_466.createFrame(-63, 22);
		    Class21.aPacketStream_466.writeDWord(544537784, 1057001181);
		...
		if (!Class36.aBoolean640) {
			...
			for (int i_37_ = i_33_ - 1; i_37_ <= 1 + i_35_;
			     i_37_++) {
			    if (i_32_ > i_36_ || i_36_ > i_34_
				|| (i_33_ ^ 0xffffffff) < (i_37_ ^ 0xffffffff)
				|| (i_35_ ^ 0xffffffff) > (i_37_
							   ^ 0xffffffff)) {
				Class92.aClass21_Sub1_1644.method330
				    ((Class68_Sub20_Sub13_Sub2.method1166
				      (2,
				       (new RSString[]
					{ Class83.aRSString_1525,
				...
				Class92.aClass21_Sub1_1644.method330
				    ((Class68_Sub20_Sub13_Sub2.method1166
				      (2,
				       (new RSString[]
					{ Class68_Sub20_Sub16.aRSString_4424,
					  Class68_Sub13_Sub24.method816(i_36_,
									0),
					  Class68_Sub20_Sub5.aRSString_4223,
					  Class68_Sub13_Sub24
		...
		if (RuntimeException_Sub1.anInt2231 != 28) {
			...
			Class21.aPacketStream_466.createFrame(64, 60);
		} else
    ...
    public Class61(Socket socket, SignLink class55) throws IOException {
	try {
	    aSignLink_1131 = class55;
	    aSocket1123 = socket;
	    aSocket1123.setSoTimeout(30000);
	    aSocket1123.setTcpNoDelay(true);
	    anInputStream1127 = aSocket1123.getInputStream();
	    anOutputStream1130 = aSocket1123.getOutputStream();
	...
	for (int i_39_ = 0; (i_39_ ^ 0xffffffff) > -100; i_39_++) {
	    int i_40_ = i_39_ - -1;
	    int i_41_ = (int) (Math.pow(2.0, (double) i_40_ / 7.0) * 300.0
			       + (double) i_40_);
	    i += i_41_;
