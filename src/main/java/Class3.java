...
public class Class3
{
    ...
    public int[] method178(boolean bool, boolean bool_0_, Class21 class21,
	...
	if ((Class38.anInt677 ^ 0xffffffff) >= (-i_21_ + i_19_ ^ 0xffffffff)
    ...
    public boolean method180(Interface4 interface4, int i, Class21 class21) {
	try {
	    anInt86++;
    ...
    public static boolean method181(int i, int i_27_, int i_28_, int i_29_,
				    int i_30_, int i_31_, Class1 class1,
				    int i_32_, long l) {
	if (class1 == null)
	    return true;
