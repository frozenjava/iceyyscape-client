...
public class Class68_Sub13_Sub39 extends Class68_Sub13
{
	...
	for (int i_53_ = -1;
		...
		if (class1_sub6.aRSString_2576 != null
			...
			|| (Class38.anInt686 ^ 0xffffffff) == -1
			|| Class38.anInt686 == 3
			|| ((Class38.anInt686 ^ 0xffffffff) == -2
	...
	if (i_77_ != 327685)
	    anIntArray4098 = null;
	anInt4108++;
	Class21.aPacketStream_466.createFrame(119, 63);
	Class21.aPacketStream_466.writeWordBigEndianA((byte) 19, i);
	Class21.aPacketStream_466.writeDWordBigEndian((byte) 127, i_76_);
    }
