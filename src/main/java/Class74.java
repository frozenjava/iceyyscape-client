...
public class Class74
{
	...
	try {
	    ...
	    class68_sub14.writeByte(32, 10);
	    class68_sub14.writeWord(false, (int) (Math.random() * 99999.0));
	    class68_sub14.writeWord(false, 508);
	    class68_sub14.method924(true, l);
	    class68_sub14.writeDWord(544537784,
				    (int) (Math.random() * 9.9999999E7));
	    class68_sub14.method914((byte) -9, class100);
	    class68_sub14.writeDWord(544537784,
				    (int) (9.9999999E7 * Math.random()));
	    class68_sub14.writeWord(false, Class68_Sub13_Sub20.anInt3780);
	    class68_sub14.writeByte(32, i);
	    int i_27_ = -21 / ((-52 - i_23_) / 55);
	    class68_sub14.writeByte(32, i_24_);
	    class68_sub14.writeDWord(544537784,
				    (int) (Math.random() * 9.9999999E7));
	    class68_sub14.writeWord(false, i_26_);
	    class68_sub14.writeWord(false, i_25_);
	    class68_sub14.writeDWord(544537784,
				    (int) (9.9999999E7 * Math.random()));
	    class68_sub14.method933(false, Class68_Sub4.aBigInteger2814,
				    Class68_Sub22.aBigInteger3136);
	    Class21.aPacketStream_466.anInt2945 = 0;
	    Class21.aPacketStream_466.writeByte(32, 48);
	    Class21.aPacketStream_466.writeByte(32,
						      class68_sub14.anInt2945);
	    Class21.aPacketStream_466.method942(class68_sub14.anInt2945,
						      (byte) 118, 0,
						      (class68_sub14
						       .aByteArray2960));
