...
public class Class68_Sub27 extends Class68
{
    ...
    public static void method1218(Class1 class1, int i, int i_0_, int i_1_,
				  int i_2_, int i_3_) {
	boolean bool = true;
	int i_4_ = i_0_;
	int i_5_ = i_0_ + i_2_;
	...
	for (class68_sub14 = new Stream(is);
	     ((class68_sub14.aByteArray2960[i + class68_sub14.anInt2945]
	       ^ 0xffffffff)
	      != -1);
	     i++) {
	    /* empty */
	...
	int i_29_ = class68_sub14.anInt2945;
	i++;
	int i_30_ = 0;
	for (class68_sub14.anInt2945 += i;
	     (class68_sub14.aByteArray2960[i_30_ + class68_sub14.anInt2945]
	      != 0);
	     i_30_++) {
	    /* empty */
	}
	...
	class68_sub14.anInt2945 += i_30_;
	int i_34_;
	for (i_34_ = 0;
	     (class68_sub14.aByteArray2960[class68_sub14.anInt2945 - -i_34_]
	      != 0);
	     i_34_++) {
	    /* empty */
	}
	...
	for (/**/;
	     ((class68_sub14.aByteArray2960[i_44_ + class68_sub14.anInt2945]
	       ^ 0xffffffff)
	      != -1);
	     i_44_++) {
	    /* empty */
	...
	for (int i_58_ = 0; i_58_ < 128; i_58_++) {
		...
		if (i_53_ == 0) {
			...
			i_53_ = -1;
		    i_57_ = -1 + class68_sub14.aByteArray2960[i_29_++];
		}
	...
	for (int i_60_ = 0; i_60_ < 128; i_60_++) {
		...
		if ((i_53_ ^ 0xffffffff) == -1) {
		    i_59_ = (16 + class68_sub14.aByteArray2960[i_33_++]
			     << -1399136158);
