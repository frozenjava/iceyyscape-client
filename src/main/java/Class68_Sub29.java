...
public class Class68_Sub29 extends Class68
{
    ...
    public static Class68_Sub20_Sub10_Sub1 method1319(int i, Class21 class21,
						      int i_0_) {
	anInt3247++;
	if (i_0_ < 53)
	...
	Class68_Sub13_Sub4.aClass68_Sub20_Sub1_3511.method1030
	    (Class68_Sub13_Sub26_Sub1.aRSString_4605, i_1_ + 3, i_2_ - -14,
	     i_5_, -1);
	int i_6_ = Class96.anInt1695;
	int i_7_ = Class13.anInt223;
	int i_8_ = 0;
	if (i == 4) {
	    for (/**/; (i_8_ ^ 0xffffffff) > (Class68_Sub13_Sub21.anInt3803
					      ^ 0xffffffff); i_8_++) {
		int i_9_ = ((-1 + (Class68_Sub13_Sub21.anInt3803 + -i_8_)) * 15
			    + (31 + i_2_));
		int i_10_ = 16777215;
		if ((i_6_ ^ 0xffffffff) < (i_1_ ^ 0xffffffff)
		    && i_4_ + i_1_ > i_6_
		    && (i_7_ ^ 0xffffffff) < (-13 + i_9_ ^ 0xffffffff)
		    && i_7_ < i_9_ + 3)
		    i_10_ = 16776960;
		Class68_Sub13_Sub4.aClass68_Sub20_Sub1_3511.method1030
		    (Class58.method579((byte) -103, i_8_), 3 + i_1_, i_9_,
		     i_10_, 0);
	    }
	...
	for (int i_11_ = 0;
		...
		for (int i_12_ = i_11_;
		     ((i_12_ ^ 0xffffffff)
		      > (Class1_Sub2.anInt2435 ^ 0xffffffff));
		     i_12_++) {
		    Login.anIntArray1515[i_12_]
			= Login.anIntArray1515[i_12_ - -1];
		    Class3.aClass46Array80[i_12_]
			= Class3.aClass46Array80[i_12_ + 1];
		    PacketParser.anIntArray1876[i_12_]
			= PacketParser.anIntArray1876[1 + i_12_];
		    Class34.anIntArray596[i_12_]
			= Class34.anIntArray596[1 + i_12_];
		    Class102.anIntArray1757[i_12_]
			= Class102.anIntArray1757[1 + i_12_];
		}
		i_11_--;
	    } else {
		...
		if (Class34.anIntArray596[i_11_] < 0) {
			...
			int i_14_
			    = (Class102.anIntArray1757[i_11_] >> -1590293168
			       & 0xff);
			int i_15_ = ((Class102.anIntArray1757[i_11_] & 0xff26)
				     >> -783890328);
			int i_16_
			    = (-Class68_Sub7.aClass1_Sub6_Sub2_2860.anInt2561
			       + (i_14_ * 128 + 64));
			int i_17_
			    = (0xff & Class102.anIntArray1757[i_11_]) * 128;
			if (i_16_ < 0)
			    i_16_ = -i_16_;
			int i_18_ = (64 + i_15_ * 128
			...
			if ((i_19_ ^ 0xffffffff) > -1)
			    i_19_ = 0;
			i_13_ = ((-i_19_ + i_17_)
				 * Class68_Sub20_Sub15.anInt4399 / i_17_);
		    }
			...
			Class68_Sub28_Sub3 class68_sub28_sub3
			    = Class68_Sub28_Sub3.method1299(class68_sub11_sub1,
							    100, i_13_);
			class68_sub28_sub3
			    .method1272(PacketParser.anIntArray1876[i_11_] + -1);
	...
	if (Class123.aBoolean2127 && !PacketParser.method1664(20778)) {
	    if ((Class68_Sub13_Sub25.anInt3855 ^ 0xffffffff) != -1
		&& (Class101.anInt1745 ^ 0xffffffff) != 0)
		Class68_Sub13_Sub38.method899(Class101.anInt1745,
					      Class21.aClass21_Sub1_459, false,
	    ...
	    Class21.aPacketStream_466.createFrame(-64, 247);
	    Class70.anInt1268++;
	    Class21.aPacketStream_466.writeDWord(544537784, Class101.anInt1745);
	...
	anInt3249++;
	while ((class68_sub14.anInt2945 ^ 0xffffffff)
	       > (class68_sub14.aByteArray2960.length ^ 0xffffffff)) {
	    int i_38_ = 0;
	    boolean bool = false;
	    int i_39_ = 0;
	    ...
	    int i_42_ = (Class103.anInt1768
			 - (1 - (-(i_41_ * 64) - -Class68_Sub1.anInt2760)));
	    int i_43_ = 64 * i_40_ + -Class70.anInt1273;
	    if (i_43_ < 0 || (-63 + i_42_ ^ 0xffffffff) > -1
		|| (63 + i_43_ ^ 0xffffffff) <= (Class68_Sub6.anInt2846
						 ^ 0xffffffff)
		|| (Class103.anInt1768 ^ 0xffffffff) >= (i_42_ ^ 0xffffffff)) {
		for (int i_44_ = 0; i_44_ < (!bool ? 4096 : 64); i_44_++) {
			...
			if ((0x1 & i_45_ ^ 0xffffffff) == -2)
			    class68_sub14.anInt2945++;
			if ((i_45_ & 0x2) == 2)
			    class68_sub14.anInt2945 += 2;
			if ((0x4 & i_45_ ^ 0xffffffff) == -5)
			    class68_sub14.anInt2945 += 3;
		    }
		}
	    } else {
		...
		for (int i_48_ = 0; i_48_ < 64; i_48_++) {
			...
			if (!bool
			    || ((i_38_ * 8 ^ 0xffffffff) >= (i_48_
							     ^ 0xffffffff)
				&& ((i_38_ * 8 + 8 ^ 0xffffffff)
				    < (i_48_ ^ 0xffffffff))
				&& (i_49_ ^ 0xffffffff) <= (8 * i_39_
							    ^ 0xffffffff)
				&& ((8 * i_39_ - -8 ^ 0xffffffff)
				    < (i_49_ ^ 0xffffffff)))) {
				...
				if ((i_50_ & 0x1 ^ 0xffffffff) == -2) {
				    ...
				    if ((Class68_Sub13_Sub11
					 .aByteArrayArrayArray3622[i_47_]
					 [i_46_])
					== null)
					Class68_Sub13_Sub11
					    .aByteArrayArrayArray3622[i_47_]
					    ...
					    = new byte[4096];
				    Class68_Sub13_Sub11
					.aByteArrayArrayArray3622[i_47_][i_46_]
					[(63 + -i_49_ << -872272474) + i_48_]
					= (byte) i_51_;
				}
				if ((i_50_ & 0x2 ^ 0xffffffff) == -3) {
				    ...
				    if ((Class68_Sub13_Sub11
					 .aShortArrayArrayArray3626[i_47_]
					 [i_46_])
					== null)
					Class68_Sub13_Sub11
					    .aShortArrayArrayArray3626[i_47_]
				...
				if ((0x4 & i_50_ ^ 0xffffffff) == -5) {
					...
					= ((0xff0000
					    & (class68_sub14.readUnsignedByte(-6677)
					       << 247340304))
					   - (-(0xff00 & (class68_sub14
							      .readUnsignedByte(-6677)
							  << -729656856))
					      + -(class68_sub14
						      .readUnsignedByte(-6677)
						  & 0xff)));
				    if ((Class68_Sub20_Sub17
					 .anIntArrayArrayArray4442[i_47_]
					 [i_46_])
					== null)
					Class68_Sub20_Sub17
					    .anIntArrayArrayArray4442[i_47_]
					    ...
					    = new int[4096];
				    Class116 class116
					= Class1_Sub5.method140(114, --i_53_);
				    ...
				    Class68_Sub20_Sub17
					.anIntArrayArrayArray4442[i_47_][i_46_]
					[(63 - i_49_ << 2087320198) + i_48_]
					= 1 + class116.anInt2031;
