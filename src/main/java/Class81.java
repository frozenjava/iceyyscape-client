...
public class Class81
{
    ...
    public static int method1454(byte i, Class21 class21) {
	if (i != -126)
	    aLong1480 = -41L;
	anInt1485++;
	int i_11_ = 0;
	...
	try {
	    ...
	    Class21.aPacketStream_466.writeByte(32, 118);
	...
	(boolean bool, int i, int i_42_, Class21 class21) {
	anInt1473++;
	if (bool != false)
	    anInt1493 = 43;
