...
public class Class68_Sub20_Sub17 extends Class68_Sub20
{
    ...
    public Class68_Sub20_Sub17(Class21 class21, Class21 class21_2_, int i,
			       boolean bool) {
	try {
	...
	(Class38 class38, int i, boolean bool, int i_9_, int i_10_, int i_11_,
	...
	if (!bool_15_ || Class28.method398(24781)
	    ...
	    if (i_12_ == 22) {
		if (Class81.aBoolean1487 || class116.anInt1983 != 0
		...
		if (class1 != null) {
			...
			for (int i_30_ = 0;
				...
				if (((Class38.aByteArrayArrayArray676[i_14_]
				      [i_11_ - -i_30_][i_9_ + i_31_])
				     ^ 0xffffffff)
				    > (i_29_ ^ 0xffffffff))
				    Class38.aByteArrayArrayArray676[i_14_]
		...
		if (bool_15_) {
			...
			if (class116.aBoolean2027) {
			    Class38.aByteArrayArrayArray676[i_14_][i_11_][i_9_]
				= (byte) 50;
			    Class38.aByteArrayArrayArray676[i_14_][i_11_]
				[1 + i_9_]
				= (byte) 50;
			}
		...
		if (class116.aBoolean2027 && bool_15_) {
			...
			Class38.aByteArrayArrayArray676[i_14_][1 + i_11_]
			    [i_9_ - -1]
			    = (byte) 50;
		}
		if ((class116.anInt2022 ^ 0xffffffff) != -1 && class38 != null)
		...
		if (class116.aBoolean2027 && bool_15_) {
			...
			Class38.aByteArrayArrayArray676[i_14_][i_11_][1 + i_9_]
			    = (byte) 50;
		}
		if (class116.anInt2022 != 0 && class38 != null)
		    class38.method461(i_10_, i_9_, class116.aBoolean2030,
