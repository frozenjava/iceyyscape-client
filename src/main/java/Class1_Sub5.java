...
public class Class1_Sub5 extends Class1
{
	...
	anInt2508++;
	if (-class68_sub14.anInt2945 + class68_sub14.aByteArray2960.length
	    >= 1) {
		...
		if (i_10_ == 3)
		    ...
		    i_11_ = 23;
		if (i_11_ <= (-class68_sub14.anInt2945
			      + class68_sub14.aByteArray2960.length)) {
		    ...
		    Class81.aBoolean1487 = class68_sub14.readUnsignedByte(-6677) == 1;
