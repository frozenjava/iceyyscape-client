...
public class PacketStream extends Stream
{
    ...
    public void method964(int[] is, int i) {
	if (i != 3426)
	    aRSString_4120 = null;
	aClass81_4116 = new Class81(is);
	anInt4125++;
    }
    
    public void method965(int i) {
	int i_0_ = 2 % ((i - 58) / 51);
	anInt4126 = 8 * anInt2945;
	anInt4112++;
    }
	...
	for (/**/; (i_3_ ^ 0xffffffff) > (i_1_ ^ 0xffffffff); i_3_ = 8) {
	    i_4_ += ((aByteArray2960[i_2_++] & Class96.anIntArray1701[i_3_])
		     << i_1_ - i_3_);
	    i_1_ -= i_3_;
	}
	if ((i_1_ ^ 0xffffffff) != (i_3_ ^ 0xffffffff))
	    i_4_ += (aByteArray2960[i_2_] >> i_3_ - i_1_
		     & Class96.anIntArray1701[i_1_]);
	else
	    i_4_ += Class96.anIntArray1701[i_3_] & aByteArray2960[i_2_];
	return i_4_;
    }
	...
	anInt4114++;
	Class36.anInt641++;
	Class21.aPacketStream_466.createFrame(-51, 111);
	if (i == -32443) {
	    Class21.aPacketStream_466.writeByte(32, i_6_);
	    Class21.aPacketStream_466.method926(128, class100.method1609(10908));
	}
    }
	...
	if (i != 255)
	    method965(21);
	return ((aByteArray2960[anInt2945++] + -aClass81_4116.method1462((byte) -55)) & 0xff);
    }
    
    public void createFrame(int junk, int packetId) {
	anInt4119++;
	aByteArray2960[anInt2945++] = (byte) (packetId + aClass81_4116.method1462((byte) -23));
    }
	...
	for (int i_13_ = 0; i_13_ < i; i_13_++)
	    is[i_13_ + i_12_]
		= (byte) (aByteArray2960[anInt2945++]
			  + -aClass81_4116.method1462((byte) 64));
	anInt4131++;
	if (bool != false)
	    aClass21_Sub1_4133 = null;
    }
