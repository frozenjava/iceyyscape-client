...
public class Class68_Sub20_Sub6 extends Class68_Sub20
{
    ...
    public int[] method1065(Interface4 interface4, int i, Class21 class21,
			    boolean bool) {
	try {
	    anInt4250++;
	...
	anInt4241++;
	Class68_Sub13_Sub8.aPacketStream_3560.method965(111);
	int i_3_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
	if (i_3_ != 0) {
	    if (i != -19342)
		anInt4240 = -21;
	    int i_4_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 2);
	    if (i_4_ == 0)
		PacketStream.anIntArray4110[Class68_Sub20_Sub16.anInt4418++] = 2047;
	    else if (i_4_ == 1) {
		int i_5_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 3);
		Class68_Sub7.aClass1_Sub6_Sub2_2860.method151(false, i_5_, (byte) 21);
		int i_6_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
		if (i_6_ == 1)
		    PacketStream.anIntArray4110[Class68_Sub20_Sub16.anInt4418++] = 2047;
	    } else if (i_4_ == 2) {
		int i_7_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 3);
		Class68_Sub7.aClass1_Sub6_Sub2_2860.method151(true, i_7_, (byte) 21);
		int i_8_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 3);
		Class68_Sub7.aClass1_Sub6_Sub2_2860.method151(true, i_8_, (byte) 21);
		int i_9_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
		if (i_9_ == 1)
		    PacketStream.anIntArray4110[Class68_Sub20_Sub16.anInt4418++] = 2047;
	    } else if (i_4_ == 3) {
		int i_10_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 7);
		int i_11_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
		Class61.anInt1149 = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 2);
		int i_12_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
		if (i_12_ == 1)
		    PacketStream.anIntArray4110[Class68_Sub20_Sub16.anInt4418++] = 2047;
		int i_13_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 7);
    ...
    public boolean method1068(Interface4 interface4, int i, Class21 class21) {
	try {
	    anInt4238++;
	    if (i != -5947)
	...
	Class81.aLong1480 = 0L;
	anInt4237++;
	if (i != -118)
	    aRSString_4232 = null;
    }
    
    public int[] method1072(byte i, Class21 class21, Interface4 interface4,
