...
public class Class90 implements Interface4
{
	...
	(Class21 class21, int i, byte i_3_, Class21 class21_4_, int i_5_) {
	try {
	    anInt2337++;
	...
	if (Class75_Sub3_Sub1.aBoolean4597) {
		...
		Class50.method531(false, 141, Class21.aPacketStream_466);
		synchronized (Class14.aClass84_241.anObject1543) {
			...
			Class83.anInt1527++;
			Class21.aPacketStream_466.createFrame(-79, 117);
			Class21.aPacketStream_466.writeByte(32, 0);
			int i = Class21.aPacketStream_466.anInt2945;
			int i_8_ = 0;
			for (int i_9_ = 0;
			     i_9_ < Class14.aClass84_241.anInt1545; i_9_++) {
			    if ((Class21.aPacketStream_466.anInt2945 + -i
				 ^ 0xffffffff)
				<= -241)
				break;
			    int i_10_
				...
				if (Class7.anInt122 < 8
					...
					.writeByte(32, Class7.anInt122 + 128);
				    i_14_ += 128;
				    Class21.aPacketStream_466.writeWord
					(false, (i_14_ << 1323552040) + i_13_);
				    Class7.anInt122 = 0;
				} else if (Class7.anInt122 < 32) {
				    Class21.aPacketStream_466
					.writeByte(32, 192 - -Class7.anInt122);
				    if (!bool_12_)
					Class21.aPacketStream_466
					    .writeDWord
					    (544537784,
					...
					Class21.aPacketStream_466
					    .writeDWord(544537784, -2147483648);
				    Class7.anInt122 = 0;
				} else {
				    Class21.aPacketStream_466.writeWord
					(false, Class7.anInt122 + 57344);
				    if (bool_12_)
					Class21.aPacketStream_466
					    .writeDWord(544537784, -2147483648);
				    else
			...
			Class21.aPacketStream_466.method935
			    (Class21.aPacketStream_466.anInt2945 - i,
			     119);
		...
		if (Class29.anInt537 != 0) {
			...
			i_18_ = 1;
		    Class21.aPacketStream_466.createFrame(-53, 59);
		    Class21.aPacketStream_466.writeWord(false, i_17_ | i_18_ << 714360111);
		    Class21.aPacketStream_466.writeDWord_v1((byte) -116, i_16_ | i << 189839792);
		}
		...
		if (Class102.aBoolean1748
		    ...
		    Class21.aPacketStream_466.createFrame(75, 99);
		    Class21.aPacketStream_466.writeWordBigEndianA((byte) 19, Class16.anInt275);
		    Class21.aPacketStream_466.writeWordA(Class8.anInt163, -22);
		}
		if (!Class15.aBoolean250 == false
		    && !Class17.aBoolean284 == true) {
		    Applet_Sub1.anInt22++;
		    Class17.aBoolean284 = true;
		    Class21.aPacketStream_466.createFrame(120, 248);
		...
		if (!Class15.aBoolean250 != false
		    ...
		    Applet_Sub1.anInt22++;
		    Class17.aBoolean284 = false;
		    Class21.aPacketStream_466.createFrame(110, 248);
		    Class21.aPacketStream_466.writeByte(32, 0);
		}
		if (!Class108.aBoolean1830) {
		    Class68_Sub22.anInt3143++;
		    Class21.aPacketStream_466.createFrame(114, 165);
		    Class21.aPacketStream_466.writeDWord_v2(-19237, Class34.method415((byte) 112));
		...
		if (RuntimeException_Sub1.anInt2231 == 30) {
			...
			if (Class54.aClass45_1033 != null) {
				...
				if (!Class87.aBoolean1587
				    ...
				    Class21.aPacketStream_466.createFrame(-86, 167);
				    Class21.aPacketStream_466.writeWordBigEndianA((byte) 19, Class68_Sub13_Sub32.anInt3978);
				    Class21.aPacketStream_466.writeByteA(-772724656, i);
				    Class21.aPacketStream_466.writeWordBigEndianA((byte) 19, Class68_Sub20_Sub2.anInt4189);
				    Class21.aPacketStream_466.writeDWordBigEndian((byte) 127, Class54.aClass45_1033.anInt792);
				}
			...
			if ((Class68_Sub13_Sub10.anInt3595 ^ 0xffffffff) != 0)
			    Class25.method384(-88,
					      ...
					      Class13_Sub3.anInt2668, 0, 0, 0,
					      0, Class68_Sub13_Sub9.anInt3568);
			...
			if (i > 4500 && i_33_ > 4500) {
			    ...
			    Class14.anInt232++;
			    Class21.aPacketStream_466.createFrame(57, 47);
			}
			...
			if (Class75_Sub2.anInt3313 > 50) {
			    Class78.anInt1392++;
			    Class21.aPacketStream_466.createFrame(-106,
								      115);
			}
    ...
    public Class90(Class21 class21, Class21 class21_60_, Class21 class21_61_,
		   int i, boolean bool) {
	aBoolean2346 = false;
	try {
	    anInt2353 = i;
