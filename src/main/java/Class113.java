...
public class Class113
{
	...
	try {
	    ...
	    Class68 class68_1_
		= aClass68Array1909[(int) ((long) (anInt1907 - 1) & l)];
	...
	try {
	    ...
	    aLong1905 = l;
	    Class68 class68
		= aClass68Array1909[(int) ((long) (-1 + anInt1907) & l)];
		...
		if ((l ^ 0xffffffffffffffffL)
		    == (aClass68_1901.aLong1218 ^ 0xffffffffffffffffL)) {
	...
	Class68_Sub18 class68_sub18
	    = ((Class68_Sub18)
	       (Class1_Sub5.aClass113_2509.method1678
		(class1_sub6_sub2.aRSString_3414.method1609(i + 10909), 127)));
	if (i != -1)
	...
	if ((Class68_Sub13_Sub34.anInt4013 ^ 0xffffffff)
	    == (class45.anInt860 ^ 0xffffffff))
	    Class121.aBooleanArray2109[class45.anInt902] = true;
	if (i >= -112)
	    method1685(null, false, true);
	anInt1916++;
    }
    ...
    public static void method1685(Class61 class61, boolean bool,
				  boolean bool_5_) {
	if (Class68_Sub25.aClass61_3167 != null) {
	    try {
		Class68_Sub25.aClass61_3167.method594(-76);
	...
	anInt1910++;
	Class68_Sub25.aClass61_3167 = class61;
	...
	for (;;) {
		...
		= ((Class68_Sub20_Sub15)
		   Class68_Sub20_Sub13.aClass113_4366.method1679(-32642));
	...
	for (;;) {
	    Class68_Sub20_Sub15 class68_sub20_sub15
		= ((Class68_Sub20_Sub15)
		   PacketParser.aClass113_1874.method1679(-32642));
	    if (class68_sub20_sub15 == null)
		break;
	    Class68_Sub7.aClass128_2854.method1786(class68_sub20_sub15,
						   (byte) 121);
	    Stream.aClass113_3008.method1677((byte) -117,
						    class68_sub20_sub15,
						    (class68_sub20_sub15
						     .aLong1218));
	    Class128.anInt2227++;
	...
	if (Class89.aByte1615 != 0) {
		...
		class68_sub14.writeByte(32, 4);
		class68_sub14.writeByte(32, Class89.aByte1615);
		class68_sub14.writeWord(false, 0);
		Class68_Sub25.aClass61_3167
		    .method590(0, (byte) 92, 4, class68_sub14.aByteArray2960);
	    } catch (java.io.IOException ioexception) {
		try {
		    Class68_Sub25.aClass61_3167.method594(-44);
		} catch (Exception exception) {
		    /* empty */
		}
		Class68_Sub25.aClass61_3167 = null;
	...
	Class16.anInt271 = 0;
	Class81.aLong1495 = Class36.method438(17161);
    }
	...
	if (aClass68_1901 == null)
	    return null;
	Class68 class68
	    = aClass68Array1909[(int) (aLong1905 & (long) (-1 + anInt1907))];
	if (i < 66)
	    aClass68_1923 = null;
	for (/**/; aClass68_1901 != class68;
	     aClass68_1901 = aClass68_1901.aClass68_1229) {
