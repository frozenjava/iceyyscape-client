...
public class Class68_Sub13_Sub15 extends Class68_Sub13
{
	...
	try {
		...
		for (/**/; i_7_ < Class32.anInt573; i_7_++) {
			...
			Class21.aPacketStream_466.createFrame(-105, 132);
			Class21.aPacketStream_466.method924(true, l);
			break;
		    }
		}
	    }
	...
	if (!Class36.aBoolean640) {
	    int i_28_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
	    int i_29_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    int i_30_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
	    int i_31_ = (-Class68_Sub13_Sub8.aPacketStream_3560.anInt2945 + Class106.anInt1804) / 16;
		...
		for (int i_33_ = 0; (i_33_ ^ 0xffffffff) > -5; i_33_++) {
		    Class68_Sub20_Sub6.anIntArrayArray4246[i_32_][i_33_] = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
                    //System.out.println("data: " + Class68_Sub20_Sub6.anIntArrayArray4246[i_32_][i_33_]);
                }
	    }
	    boolean bool_34_ = false;
	    int i_35_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
	    int i_36_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(i + 1355769449);
	    ...
	    Class81.method1455((byte) -12, i_29_, i_35_, false, i_30_, i_28_, i_36_);
	} else {
	    int i_40_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteA();
	    int i_41_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(i + 1355769449);
	    int i_42_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
	    Class68_Sub13_Sub8.aPacketStream_3560.method965(i + 17);
		...
		for (int i_44_ = 0; (i_44_ ^ 0xffffffff) > -14; i_44_++) {
			...
			int i_46_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
			if (i_46_ == 1)
			    Class68_Sub2.anIntArrayArrayArray2796[i_43_][i_44_][i_45_] = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 26);
			else
			    Class68_Sub2.anIntArrayArrayArray2796[i_43_][i_44_][i_45_] = -1;
		    }
		}
	    }
	    Class68_Sub13_Sub8.aPacketStream_3560.method966((byte) -59);
	    int i_47_ = (-Class68_Sub13_Sub8.aPacketStream_3560.anInt2945 + Class106.anInt1804) / 16;
		...
		for (int i_49_ = 0; (i_49_ ^ 0xffffffff) > -5; i_49_++)
		    Class68_Sub20_Sub6.anIntArrayArray4246[i_48_][i_49_] = Class68_Sub13_Sub8.aPacketStream_3560.method940((byte) 115);
	    }
	    int i_50_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
	    int i_51_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
