...
public class Class68_Sub20_Sub11 extends Class68_Sub20
{
	...
	while (i_18_ != i_16_) {
		...
		if (((i_3_ ^ 0xffffffff) > -6 || (i_3_ ^ 0xffffffff) == -11)
		    && (Class109.aClass38Array1843[Class61.anInt1149].method459
		...
		if (i_3_ < 10
		    && (Class109.aClass38Array1843[Class61.anInt1149].method462
		...
		&& (Class109.aClass38Array1843[Class61.anInt1149].method448
		...
		if (Class68_Sub13_Sub13.anInt3663 > 0
			...
			= Class68_Sub13_Sub3.method713(0, 0,
							...
							.anIntArray2570[0]),
						       ...
						       -3, 1, i_65_);
		    if (bool) {
			Class21.aPacketStream_466.writeByte(32, i_56_);
			Class21.aPacketStream_466.writeByte(32, i_55_);
			Class21.aPacketStream_466
			    .writeWord(false, Class8.anInt163);
			Class21.aPacketStream_466.writeByte(32, 57);
			Class21.aPacketStream_466
			    .writeByte(32, Class68_Sub13_Sub26.anInt3883);
			Class21.aPacketStream_466
			    .writeByte(32, Class68_Sub20_Sub16.anInt4420);
			Class21.aPacketStream_466.writeByte(32, 89);
			...
			Class21.aPacketStream_466
			    .writeByte(32, Class32.anInt565);
			Class21.aPacketStream_466.writeByte(32, 63);
		    }
		}
	    }
	}
