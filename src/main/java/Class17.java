...
public class Class17
{
	...
	if (i != RuntimeException_Sub1.anInt2231) {
	    ...
	    if ((i ^ 0xffffffff) == -41)
		Class16.method283(Class68_Sub28_Sub2.aRSString_4552, 104,
				  Class68_Sub28_Sub2.aRSString_4551,
				  Class68_Sub13_Sub5.anInt3518);
	    boolean bool = ((i ^ 0xffffffff) == -6 || (i ^ 0xffffffff) == -11
			    || (i ^ 0xffffffff) == -29);
		...
		= (RuntimeException_Sub1.anInt2231 == 5
		   ...
		   || (RuntimeException_Sub1.anInt2231 ^ 0xffffffff) == -29);
	    if (!bool_1_ != !bool) {
		if (bool) {
	...
	if (class45 != null) {
		...
		if ((i_9_ ^ 0xffffffff) == -2) {
		    Class103.anInt1772++;
		    Class21.aPacketStream_466.createFrame(104, 233);
		    Class21.aPacketStream_466.writeDWord(544537784, i);
		    Class21.aPacketStream_466.writeWord(false, i_10_);
		}
		if ((i_9_ ^ 0xffffffff) == -3) {
		    Class71_Sub1.anInt3253++;
		    Class21.aPacketStream_466.createFrame(95, 21);
		    Class21.aPacketStream_466.writeDWord(544537784, i);
		    Class21.aPacketStream_466.writeWord(false, i_10_);
		}
		if (i_9_ == 3) {
		    Class102.anInt1750++;
		    Class21.aPacketStream_466.createFrame(116, 169);
		    Class21.aPacketStream_466.writeDWord(544537784, i);
		    Class21.aPacketStream_466.writeWord(false, i_10_);
		}
		if (i_9_ == 4) {
		    Class21.aPacketStream_466.createFrame(-114, 214);
		...
		if (i_9_ == 5) {
		    Class57.anInt1079++;
		    Class21.aPacketStream_466.createFrame(82, 173);
		    Class21.aPacketStream_466.writeDWord(544537784, i);
		    Class21.aPacketStream_466.writeWord(false, i_10_);
		}
		if (i_9_ == 6) {
		    Class68_Sub13_Sub6.anInt3527++;
		    Class21.aPacketStream_466.createFrame(119, 232);
		    Class21.aPacketStream_466.writeDWord(544537784, i);
		    Class21.aPacketStream_466.writeWord(false, i_10_);
		}
		if ((i_9_ ^ 0xffffffff) == -8) {
		    Class75_Sub3_Sub1.anInt4600++;
		    Class21.aPacketStream_466.createFrame(-85, 133);
		    Class21.aPacketStream_466.writeDWord(544537784, i);
		    Class21.aPacketStream_466.writeWord(false, i_10_);
		}
		if ((i_9_ ^ 0xffffffff) == -9) {
		    Class21.aPacketStream_466.createFrame(-72, 102);
		    Class68_Sub13_Sub34.anInt4011++;
		    Class21.aPacketStream_466.writeDWord(544537784, i);
		    Class21.aPacketStream_466.writeWord(false, i_10_);
		}
		if (i_9_ == 9) {
		    Class21.aPacketStream_466.createFrame(-94, 226);
		...
		if (i_9_ == 10) {
		    Class29.anInt534++;
		    Class21.aPacketStream_466.createFrame(124, 90);
		    Class21.aPacketStream_466.writeDWord(544537784, i);
		    Class21.aPacketStream_466.writeWord(false, i_10_);
		}
	    }
