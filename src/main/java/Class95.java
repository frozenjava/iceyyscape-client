...
public class Class95
{
	...
	if (Class68_Sub13_Sub8.aPacketStream_3560.anInt2945 != Class106.anInt1804)
	    throw new RuntimeException("gpp1 pos:" + (Class68_Sub13_Sub8.aPacketStream_3560.anInt2945) + " psize:" + Class106.anInt1804);
	int i_32_ = 0;
	if (i >= -68)
	    method1551((byte) -52);
