...
public class Class68_Sub20_Sub9 extends Class68_Sub20
{
	...
	anInt4298++;
	Class16 class16
	    = Class45.aClass16ArrayArrayArray926[Class61.anInt1149][i][i_1_];
	if (class16 == null)
	    Class68_Sub13_Sub22.method811(Class61.anInt1149, i, i_1_);
	else {
	    if (i_0_ != -52)
		...
		Class1_Sub7.method169(Class61.anInt1149, i, i_1_,
