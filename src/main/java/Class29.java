...
public class Class29
{
	...
	for (int i_2_ = i;
		...
		if (i_0_ == 1) {
		    ...
		    Class21.aPacketStream_466.createFrame(i ^ 0x61, 160);
		    Class21.aPacketStream_466.writeWordBigEndian(Class85.anIntArray1563[i_2_], (byte) 38);
		} else if ((i_0_ ^ 0xffffffff) == -5) {
		    Class112.anInt1877++;
		    Class21.aPacketStream_466.createFrame(-78, 253);
		    ...
		    Class21.aPacketStream_466.createFrame(-64, 35);
		    Class21.aPacketStream_466
			.writeWordBigEndianA((byte) 19, Class85.anIntArray1563[i_2_]);
		} else if (i_0_ == 7) {
		    Class21.aPacketStream_466.createFrame(-98, 93);
		    Class21.aPacketStream_466
			.writeWordBigEndianA((byte) 19, Class85.anIntArray1563[i_2_]);
