...
public class Class13_Sub2 extends Class13
{
    ...
    public static Class31 aClass31_2657;
	...
	if (class68_sub18 == null)
	    Class52.method543(19395, class1_sub6_sub2.anIntArray2570[0], null,
			      ...
			      Class61.anInt1149, class1_sub6_sub2);
	else
	    class68_sub18.method993(31506);
    }
    
    public static Class92_Sub1[] method256(Class21 class21, int i, int i_5_,
					   int i_6_) {
	anInt2655++;
	if (i_6_ > -93)
	    return null;
	...
	try {
	    anInt2644++;
	    int i_12_ = class68_sub14.anInt2945;
	    class68_sub14.method956(class100.anInt2293, -1);
	    class68_sub14.anInt2945 += (Class68_Sub16.aClass103_3028.method1632(class100.anInt2293, class68_sub14.aByteArray2960, class100.aByteArray2268, -2147483648, class68_sub14.anInt2945, i));
	    return -i_12_ + class68_sub14.anInt2945;
