...
public abstract class Class21
{
    ...
    public static PacketStream aPacketStream_466
	...
	if (is == null
	    ...
	    is_16_
		= Class1.method53(false, (byte) -4, anObjectArray435[i_10_]);
	else {
	    is_16_ = Class1.method53(true, (byte) -4, anObjectArray435[i_10_]);
	    Stream class68_sub14 = new Stream(is_16_);
	    class68_sub14.method946(is, 5, class68_sub14.aByteArray2960.length,
				    (byte) 102);
	}
	byte[] is_17_;
	try {
	...
	if (i != -18982)
	    return null;
	class100.aByteArray2268 = new byte[i_35_];
	...
	byte[] is = Class1.method53(false, (byte) -4,
    ...
    public static void method348(Class21 class21, byte i,
				 Class21 class21_48_) {
	try {
	...
	byte[] is_74_ = Class1.method53(false, (byte) -4,
    ...
    public Class21(boolean bool, boolean bool_110_) {
