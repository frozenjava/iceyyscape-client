...
public class PacketParser
{
	...
	for (;;) {
		...
		if (bool_5_) {
			...
			if ((i_12_ ^ 0xffffffff) != -23 || Class81.aBoolean1487
    ...
    public static void method1662(boolean bool, int i, int i_13_, int i_14_,
				  Class21 class21, boolean bool_15_,
				  int i_16_) {
	if (bool_15_ != false)
	    method1666((byte) 81);
    ...
    public static void method1665(Class21 class21, byte i,
				  Class21 class21_22_) {
	do {
	    try {
		anInt1862++;
	...
	if (Class126.aClass61_2190 == null)
	    return false;
	int i_23_ = Class126.aClass61_2190.method597((byte) 102);
	if ((i_23_ ^ 0xffffffff) == -1)
	    return false;
	if ((Class49.anInt962 ^ 0xffffffff) == 0) {
	    i_23_--;
	    Class126.aClass61_2190.method591(i ^ 0x66d8, 1, 0,
					     (Class68_Sub13_Sub8
					      .aPacketStream_3560
					      .aByteArray2960));
	    Class68_Sub13_Sub8.aPacketStream_3560.anInt2945 = 0;
	    Class49.anInt962
		= Class68_Sub13_Sub8.aPacketStream_3560.method972(255);
	...
	if (Class106.anInt1804 == -1) {
	    if ((i_23_ ^ 0xffffffff) >= -1)
		return false;
	    Class126.aClass61_2190.method591(i ^ ~0x66ab, 1, 0,
					     (Class68_Sub13_Sub8
					      .aPacketStream_3560
					      .aByteArray2960));
	    Class106.anInt1804
		= 0xff & (Class68_Sub13_Sub8.aPacketStream_3560
			  .aByteArray2960[0]);
	    i_23_--;
	}
	if (Class106.anInt1804 == -2) {
		...
		i_23_ -= 2;
		Class126.aClass61_2190.method591(117, 2, 0,
						 (Class68_Sub13_Sub8
						  .aPacketStream_3560
						  .aByteArray2960));
		Class68_Sub13_Sub8.aPacketStream_3560.anInt2945 = 0;
	...
	if (Class106.anInt1804 > i_23_)
	    return false;
	Class68_Sub13_Sub8.aPacketStream_3560.anInt2945 = 0;
	Class126.aClass61_2190.method591(107, Class106.anInt1804, 0,
					 (Class68_Sub13_Sub8
					  .aPacketStream_3560
					  .aByteArray2960));
	...
	if (Class49.anInt962 == 93) {
	    int i_24_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(1355769544);
	    int i_25_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteA();
	    int i_26_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
	...
	if (Class49.anInt962 == 217) {
	    ...
	    int i_27_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
	    int i_28_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v2(false);
	    int i_29_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
		...
		if (i_28_ >= Class61.anIntArray1128[i_30_])
	...
	if (Class49.anInt962 == 57) {
	    int i_31_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	    int i_32_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteA();
	    int i_33_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteA();
	    Class61.anInt1149 = i_31_ >> 1847841633;
	...
	if (Class49.anInt962 == 132) {
	    Class68_Sub13_Sub11.method747(Class68_Sub13_Sub8.aPacketStream_3560.readString(127), (byte) 125);
	    Class49.anInt962 = -1;
	    return true;
	}
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -42) {
	    int i_34_
		= Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v1();
	    int i_35_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
	    Class45 class45
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -224) {
	    int i_36_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .readUnsignedWord(1355769544);
	    int i_37_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    if (i_37_ == 65535)
		i_37_ = -1;
	    int i_38_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .method940((byte) 121);
	    if ((i_36_ ^ 0xffffffff) == -65536)
		i_36_ = -1;
	    int i_39_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .method940((byte) 126);
	    for (int i_40_ = i_37_;
	...
	if (Class49.anInt962 == 115) {
	    Class45.anInt917 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    Class123.anInt2130 = Class68_Sub22.anInt3148;
	    Class49.anInt962 = -1;
	    return true;
	}
	if ((Class49.anInt962 ^ 0xffffffff) == -56) {
	    Class69.method1328(Class68_Sub13_Sub8.aPacketStream_3560, 24);
	    Class49.anInt962 = -1;
	    return true;
	}
	if ((Class49.anInt962 ^ 0xffffffff) == -118) {
	    int i_41_ = (Class106.anInt1804 + Class68_Sub13_Sub8.aPacketStream_3560.anInt2945);
	    int i_42_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(1355769544);
	    int i_43_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(1355769544);
		...
		int i_45_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
		int i_46_ = Class68_Sub13_Sub8.aPacketStream_3560
				.readUnsignedWord(i + 1355795898);
		int i_47_ = Class68_Sub13_Sub8.aPacketStream_3560
	    ...
	    while ((Class68_Sub13_Sub8.aPacketStream_3560.anInt2945
		    ^ 0xffffffff)
		   > (i_41_ ^ 0xffffffff)) {
		int i_48_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
		int i_49_ = Class68_Sub13_Sub8.aPacketStream_3560
				.readUnsignedWord(1355769544);
		int i_50_ = Class68_Sub13_Sub8.aPacketStream_3560
				.readUnsignedWord(1355769544);
		int i_51_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
		for (int i_52_ = i_49_;
	...
	if (Class49.anInt962 == 64) {
	    int i_53_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    if ((i_53_ ^ 0xffffffff) == -65536)
		i_53_ = -1;
	    int i_54_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v1();
	    Class45 class45
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -241) {
		...
		Class21_Sub1.aLongArray2703[i_55_]
		    = Class68_Sub13_Sub8.aPacketStream_3560
			  .method941(Class15.method278(i, -26299));
	...
	if (Class49.anInt962 == 154) {
	    long l = Class68_Sub13_Sub8.aPacketStream_3560
			 .method941(i + 26465);
	    int i_56_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .readUnsignedWord(1355769544);
	    int i_57_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    RSString class100 = Class68_Sub28_Sub2.aRSString_4556;
	    if (i_56_ > 0)
		class100 = Class68_Sub13_Sub8.aPacketStream_3560
			       .readString(127);
	    boolean bool = true;
	...
	if (Class49.anInt962 == 229) {
	    long l = Class68_Sub13_Sub8.aPacketStream_3560.method941(61);
	    Class68_Sub13_Sub8.aPacketStream_3560.method955(3390);
	    long l_69_
		= Class68_Sub13_Sub8.aPacketStream_3560.method941(105);
	    long l_70_ = (long) Class68_Sub13_Sub8.aPacketStream_3560
				    .readUnsignedWord(1355769544);
	    boolean bool = false;
	    long l_71_ = (long) Class68_Sub13_Sub8.aPacketStream_3560
				    .method921((byte) 87);
	    long l_72_ = l_71_ + (l_70_ << 255256160);
	    int i_73_ = Class68_Sub13_Sub8.aPacketStream_3560
	...
	while_150_:
		...
		Class97.aLongArray1711[Class61.anInt1138] = l_72_;
		Class61.anInt1138 = (Class61.anInt1138 - -1) % 100;
		RSString class100
	...
	if (Class49.anInt962 == 124) {
	    Class68_Sub28_Sub1.anInt4491 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
	    Class93.anInt1668
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	...
	if (Class49.anInt962 == 121) {
	    long l = Class68_Sub13_Sub8.aPacketStream_3560.method941(46);
	    int i_76_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .readUnsignedWord(1355769544);
	    byte i_77_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .method955(i ^ ~0x6bcf);
	    boolean bool = false;
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -150) {
	    long l = Class68_Sub13_Sub8.aPacketStream_3560
			 .method941(i + 26456);
	    long l_83_ = (long) Class68_Sub13_Sub8.aPacketStream_3560
				    .readUnsignedWord(1355769544);
	    long l_84_ = (long) Class68_Sub13_Sub8.aPacketStream_3560
				    .method921((byte) -69);
	    long l_85_ = l_84_ + (l_83_ << 1243878112);
	    int i_86_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .readUnsignedByte(i + 19677);
	    boolean bool = false;
	    int i_87_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .readUnsignedWord(1355769544);
	while_151_:
	    do {
		...
		Class97.aLongArray1711[Class61.anInt1138] = l_85_;
		Class61.anInt1138 = (1 + Class61.anInt1138) % 100;
		RSString class100
		    = (Class118.method1731(i_87_, (byte) 76).method1093
		       (-90, Class68_Sub13_Sub8.aPacketStream_3560));
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -196) {
	    int i_90_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v1();
	    int i_91_ = (i_90_ & 0x32edbabc) >> -375335812;
	    int i_92_ = 0x3fff & i_90_ >> 1567317006;
	    int i_93_ = 0x3fff & i_90_;
	    int i_94_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .readUnsignedWord(1355769544);
	...
	if (Class49.anInt962 == 156) {
	    int i_99_ = Class68_Sub13_Sub8.aPacketStream_3560
			    .method940((byte) 88);
	    int i_100_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
	    int i_101_ = Class68_Sub13_Sub8.aPacketStream_3560
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -102) {
	    int i_102_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
	    Class45 class45
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -177) {
	    long l = Class68_Sub13_Sub8.aPacketStream_3560.method941(87);
	    Class68_Sub13_Sub8.aPacketStream_3560.method955(3390);
	    long l_103_
		= Class68_Sub13_Sub8.aPacketStream_3560.method941(72);
	    ...
	    long l_105_ = (long) Class68_Sub13_Sub8
				     .aPacketStream_3560
				     .method921((byte) -114);
	    int i_106_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedByte(i + 19677);
	    int i_107_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(1355769544);
	...
	while_152_:
	    ...
	    if (!bool && (Class116.anInt2011 ^ 0xffffffff) == -1) {
		Class97.aLongArray1711[Class61.anInt1138] = l_108_;
		Class61.anInt1138 = (1 + Class61.anInt1138) % 100;
		RSString class100
		    = (Class118.method1731(i_107_, (byte) 101).method1093
		       (-37, Class68_Sub13_Sub8.aPacketStream_3560));
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -140) {
	    Class12.method238(Class75_Sub1_Sub1.aSignLink_4589, Class68_Sub13_Sub8.aPacketStream_3560, Class106.anInt1804, (byte) 101);
	    Class49.anInt962 = -1;
	    return true;
	}
	if ((Class49.anInt962 ^ 0xffffffff) == -13) {
	    ...
	    int i_114_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    int i_115_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(1355769544);
	...
	if (Class49.anInt962 == 178) {
	    ...
	    long l_117_ = (long) Class68_Sub13_Sub8
				     .aPacketStream_3560
				     .method921((byte) -112);
	    int i_118_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedByte(i ^ 0x7ce5);
	...
	while_153_:
	    ...
	    if (!bool && Class116.anInt2011 == 0) {
		Class97.aLongArray1711[Class61.anInt1138] = l_119_;
		Class61.anInt1138 = (Class61.anInt1138 - -1) % 100;
		RSString class100
		    = (Class68_Sub20_Sub1.method1009
		       (Class68_Sub19.method996
			    (27, Class68_Sub13_Sub8.aPacketStream_3560)
			    .method1616(2)));
	...
	if (Class49.anInt962 == 179) {
	    RSString class100 = Class68_Sub13_Sub8.aPacketStream_3560.readString(127);
	    int i_122_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v1();
	...
	if (Class49.anInt962 == 100) {
	    int i_123_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
	    byte i_124_ = Class68_Sub13_Sub8.aPacketStream_3560.method919((byte) 46);
	...
	if (Class49.anInt962 == 146) {
	    int i_125_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    if (i_125_ == 65535)
		i_125_ = -1;
	...
	if (Class49.anInt962 == 251) {
	    int i_126_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    int i_127_
		= Class68_Sub13_Sub8.aPacketStream_3560.method930(false);
	    if (i_126_ == 65535)
		i_126_ = -1;
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -240) {
	    int i_128_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(1355769544);
	    int i_129_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteA();
	    if (i_129_ == 2)
	...
	if (Class49.anInt962 == 135) {
	    int i_131_
		= Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
	    int i_132_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(1355769544);
	    Class45 class45;
		...
		int i_133_ = Class68_Sub13_Sub8.aPacketStream_3560
				 .method912(255);
		int i_134_ = Class68_Sub13_Sub8.aPacketStream_3560
				 .readUnsignedWord(1355769544);
		int i_135_ = 0;
		if (i_134_ != 0) {
		    i_135_ = Class68_Sub13_Sub8.aPacketStream_3560
				 .readUnsignedByte(-6677);
		    if ((i_135_ ^ 0xffffffff) == -256)
			i_135_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
		}
	...
	if (Class49.anInt962 == 120) {
	    int i_136_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .method957(-22489);
	    int i_137_
		= Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v2(false);
	    int i_138_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .method957(-22489);
	    Class45 class45
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -235) {
	    long l = Class68_Sub13_Sub8.aPacketStream_3560.method941(86);
	    int i_139_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(1355769544);
	    RSString class100
		= (Class118.method1731(i_139_, (byte) 96).method1093
		   (114, Class68_Sub13_Sub8.aPacketStream_3560));
	    Class25.method386(null, -19596,
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -185) {
	    int i_140_
		= Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
	    int i_141_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	...
	if (Class49.anInt962 == 137) {
	    int i_146_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    if (Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677) == 0)
		Class63.aClass49Array1171[i_146_] = new Class49();
	    else {
		Class68_Sub13_Sub8.aPacketStream_3560.anInt2945--;
		Class63.aClass49Array1171[i_146_] = new Class49(Class68_Sub13_Sub8.aPacketStream_3560);
	    }
	...
	if (Class49.anInt962 == 249) {
	    Class68_Sub28_Sub1.anInt4491 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    Class93.anInt1668 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
		...
		for (int i_148_ = Class68_Sub28_Sub1.anInt4491; ((i_148_ ^ 0xffffffff) > (8 + Class68_Sub28_Sub1.anInt4491 ^ 0xffffffff)); i_148_++) {
		    if ((Class45.aClass16ArrayArrayArray926[Class61.anInt1149][i_147_][i_148_]) != null) {
			Class45.aClass16ArrayArrayArray926[Class61.anInt1149][i_147_][i_148_] = null;
		...
		if ((class68_sub2.anInt2791 ^ 0xffffffff) <= (Class93.anInt1668
		    ...
		    && class68_sub2.anInt2789 == Class61.anInt1149)
	...
	if (Class49.anInt962 == 119) {
	    int i_149_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(1355769544);
	    if (i_149_ == 65535)
		i_149_ = -1;
	    int i_150_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    int i_151_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(i ^ ~0x50cf0039);
	...
	if (Class49.anInt962 == 170) {
	    ...
	    int i_152_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    int i_153_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	...
	if (Class49.anInt962 == 8) {
	    Class104.anInt1784 = 30 * Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	...
	if (Class49.anInt962 == 172) {
	    int i_156_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -83) {
	    Class68_Sub28_Sub2.anInt4547 = Class68_Sub22.anInt3148;
	    long l = Class68_Sub13_Sub8.aPacketStream_3560.method941(97);
	    if (l == 0L) {
	    ...
	    long l_157_
		= Class68_Sub13_Sub8.aPacketStream_3560.method941(100);
	...
	if (Class49.anInt962 == 40) {
	    int i_162_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(i ^ ~0x50cf0039);
	    int i_163_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(108);
	...
	if (Class49.anInt962 == 59) {
	    boolean bool = (Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC() == 1);
	    int i_164_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v1();
	...
	if (Class49.anInt962 == 247) {
	    int i_165_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordA();
	    int i_166_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
	    int i_167_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -178) {
	    Class68_Sub28_Sub1.anInt4491 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    Class93.anInt1668 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	    Class49.anInt962 = -1;
	    return true;
	}
	if ((Class49.anInt962 ^ 0xffffffff) == -141) {
	    int i_168_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(i ^ ~0x50cf0039);
	    int i_169_
		= Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
	    int i_170_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(-96);
	    int i_171_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(1355769544);
	...
	if (Class49.anInt962 == 174) {
	    int i_177_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(1355769544);
	    int i_178_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(-49);
	    int i_179_
		= Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v2(false);
	    Class45 class45
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -246) {
	    int i_180_
		= Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v2(false);
	    int i_181_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .method957(-22489);
	    Class45 class45
	...
	if (Class49.anInt962 == 211) {
	    ...
	    int i_186_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    int i_187_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(1355769544);
	    int i_188_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    int i_189_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedByte(i + 19677);
	...
	if (Class49.anInt962 == 10) {
	    int i_190_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	    int i_191_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    int i_192_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    Class1_Sub6_Sub1 class1_sub6_sub1
	...
	if (Class49.anInt962 == 252) {
	    int i_193_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
	    RSString class100 = Class68_Sub13_Sub8.aPacketStream_3560.readString(127);
	    int i_194_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteC();
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -50) {
	    int i_195_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(-82);
	    int i_196_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(i + 1355795898);
	    int i_197_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .method940((byte) 123);
	    int i_198_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(102);
	    Class45 class45
	...
	if (Class49.anInt962 == 109) {
	    int i_200_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
	    int i_201_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(-60);
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -194) {
	    ...
	    int i_203_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    int i_204_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(1355769544);
	    int i_205_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    int i_206_
	...
	if (Class49.anInt962 == 6) {
		...
		= Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v2(false);
	    int i_209_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(-43);
	    Class45 class45
	...
	if (Class49.anInt962 == 218) {
	    RSString class100 = Class68_Sub13_Sub8.aPacketStream_3560
				    .readString(i ^ ~0x668e);
		...
		if (!class100.method1573(Class8.aRSString_165, true)) {
			...
			long l = class100_210_.method1609(10908);
			boolean bool = false;
			for (int i_211_ = 0;
			     ((i_211_ ^ 0xffffffff)
			      > (Class68_Sub13_Sub26.anInt3880 ^ 0xffffffff));
			...
			if (!class100.method1573(Class104.aRSString_1777,
				...
				long l = class100_213_.method1609(i ^ ~0x4c6d);
				boolean bool = false;
				for (int i_214_ = 0;
				     ((i_214_ ^ 0xffffffff)
				...
				long l = class100_215_.method1609(10908);
				boolean bool = false;
				for (int i_216_ = 0;
				     ((Class68_Sub13_Sub26.anInt3880
				       ^ 0xffffffff)
				...
				long l = class100_217_.method1609(i ^ ~0x4c6d);
				boolean bool = false;
				for (int i_218_ = 0;
		    ...
		    long l = class100_221_.method1609(10908);
		    boolean bool = false;
		    for (int i_222_ = 0;
			 ((i_222_ ^ 0xffffffff)
			  > (Class68_Sub13_Sub26.anInt3880 ^ 0xffffffff));
		...
		RSString class100_224_
			...
			class100.method1595(i ^ 0x668d,
					    Class13.aRSString_218)));
		long l = class100_224_.method1609(10908);
		boolean bool = false;
		for (int i_225_ = 0;
		     ((i_225_ ^ 0xffffffff)
		      > (Class68_Sub13_Sub26.anInt3880 ^ 0xffffffff));
	...
	if (Class49.anInt962 == 161) {
	    int i_226_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(1355769544);
	    int i_227_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v1();
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -228) {
		...
		if ((class23.anInt489 ^ 0xffffffff) == -2
			...
			= Class68_Sub13_Sub8.aPacketStream_3560
			      .readUnsignedWord(1355769544);
		    Class68_Sub13_Sub8.aPacketStream_3560.anInt2945 += 3;
	...
	if (Class49.anInt962 == 190) {
	    int i_230_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .readUnsignedWord(i + 1355795898);
	...
	if (Class49.anInt962 == 246) {
	    int i_231_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
	    Class68_Sub3 class68_sub3
		= ((Class68_Sub3)
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -192) {
		...
		= Class68_Sub13_Sub8.aPacketStream_3560.readString(127);
	    int i_232_
		= Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(-91);
	    int i_233_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	...
	if (Class49.anInt962 == 255) {
	    int i_234_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord();
	    int i_235_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(1355769544);
	    Class45 class45;
	    if (i_234_ >= 0)
	    ...
	    int i_237_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWord(i ^ ~0x50cf0039);
	    for (int i_238_ = 0; i_237_ > i_238_; i_238_++) {
		int i_239_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
		if (i_239_ == 255)
		    i_239_ = Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v2(false);
		int i_240_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndian(i ^ ~0x6698);
	...
	if ((Class49.anInt962 ^ 0xffffffff) == -2) {
	    int i_241_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByteS();
	    int i_242_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	...
	if (Class49.anInt962 == 99) {
	    Class68_Sub13.method701(0);
	    Class68_Sub20_Sub9.anInt4295 = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    Class68_Sub20_Sub5.anInt4220 = Class68_Sub22.anInt3148;
	    Class49.anInt962 = -1;
	    return true;
	}
	if (Class49.anInt962 == 35) {
	    int i_243_
		= Class68_Sub13_Sub8.aPacketStream_3560.readDWord_v2(false);
	    int i_244_ = Class68_Sub13_Sub8.aPacketStream_3560
			     .method940((byte) 103);
	    int i_245_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedWordBigEndianA();
	    Class45 class45
