...
public class Class107
{
	...
	anInt1823++;
	if (i_2_ != 0) {
	    Class21.aPacketStream_466.createFrame(122, 67);
	    Class21.aPacketStream_466.writeByte(32, 0);
	    int i_3_ = Class21.aPacketStream_466.anInt2945;
	    int i_4_ = 0;
		...
		if ((i_4_ ^ 0xffffffff) > -256
		    ...
		    Class21.aPacketStream_466.writeByte(32, i_4_);
		    i_4_ = 0;
		    Class21.aPacketStream_466
			.writeWord(false, class68_sub10.anInt2902);
		}
		i_5_ = class68_sub10.anInt2902;
	    }
	    Class21.aPacketStream_466.writeByte(32, i_4_);
	    Class21.aPacketStream_466.method935
		(-i_3_ + Class21.aPacketStream_466.anInt2945, 125);
	}
    }
