...
public class Class68_Sub13_Sub27 extends Class68_Sub13
{
	...
	if (i <= Class51.anInt2255
	    ...
	    boolean bool;
	    if ((Class38.anInt677 ^ 0xffffffff) >= (i_7_ ^ 0xffffffff)) {
		...
		bool = false;
		i_7_ = Class38.anInt677;
	    }
	    boolean bool_9_;
	    if (i_4_ < Class38.anInt677) {
		i_4_ = Class38.anInt677;
		bool_9_ = false;
	...
	class100.aByteArray2268 = new byte[i];
	class100.anInt2293 = 0;
	for (int i_58_ = i_57_;
	     (i_57_ + i ^ 0xffffffff) < (i_58_ ^ 0xffffffff); i_58_++) {
	    if ((is[i_58_] ^ 0xffffffff) != -1)
		class100.aByteArray2268[class100.anInt2293++] = is[i_58_];
	}
	if (i_56_ < 36)
	    anInt3915 = -90;
	return class100;
	...
	for (int i_60_ = 0; i_59_ > i_60_; i_60_++) {
		...
		if ((i_61_ ^ 0xffffffff) <= -1 && i_61_ < 104
			...
			class1_sub6_sub2.anInt2582
			    = Class1_Sub6_Sub2.method163((class1_sub6_sub2
							 ...
							 (class1_sub6_sub2
							  .anInt2537),
							 false);
			Class122.method1747(Class61.anInt1149,
			...
			Class68_Sub20_Sub4.method1061
			    (Class61.anInt1149, class1_sub6_sub2.anInt2561,
			     class1_sub6_sub2.anInt2537,
			     class1_sub6_sub2.anInt2582,
