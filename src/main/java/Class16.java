...
public class Class16
{
	...
	Class68_Sub13_Sub35.aByteArrayArrayArray4028
	    = new byte[i_0_][104][104];
	Class38.aByteArrayArrayArray676 = new byte[i_0_][105][105];
    ...
    public static void method283(RSString class100, int i,
				 RSString class100_1_, int i_2_) {
	try {
	    Class68_Sub28_Sub2.aRSString_4552 = class100;
	    anInt264++;
	    Class68_Sub28_Sub2.aRSString_4551 = class100_1_;
	    Class75_Sub3_Sub1.aBoolean4597 = false;
	    Class36.anInt642 = 0;
	    Class68_Sub13_Sub5.anInt3518 = i_2_;
	    if (Class68_Sub28_Sub2.aRSString_4551
		    .method1593(Class68_Sub28_Sub2.aRSString_4556, (byte) 116)
		|| (Class68_Sub28_Sub2.aRSString_4552.method1593
		    (Class68_Sub28_Sub2.aRSString_4556, (byte) 127))) {
	...
	for (int i_4_ = i; Class68_Sub20_Sub16.anInt4418 > i_4_; i_4_++) {
	    ...
	    int i_6_ = Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(-6677);
	    if ((i_6_ & 0x10) != 0)
		i_6_ += Class68_Sub13_Sub8.aPacketStream_3560.readUnsignedByte(i + -6677) << -1148449432;
