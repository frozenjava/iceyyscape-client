...
public class Class68_Sub13_Sub11 extends Class68_Sub13
{
			   ...
			   (2,
			    (new RSString[]
			     { class100_21_, Class75_Sub3.aRSString_3320,
			       ...
			       Class126.method1765(94608000L, -96) })));
		else
		    class100_21_
			= (Class68_Sub20_Sub13_Sub2.method1166
	...
	if (i <= 14)
	    method753(-56, 26);
	int i_28_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 8);
	...
	for (int i_30_ = 0; (i_28_ ^ 0xffffffff) < (i_30_ ^ 0xffffffff); i_30_++) {
	    ...
	    int i_32_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
	    if (i_32_ == 0) {
		Class85.anIntArray1563[client.anInt2382++] = i_31_;
		class1_sub6_sub2.anInt2575 = Class68_Sub3.anInt2812;
	    } else {
		int i_33_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 2);
		if (i_33_ == 0) {
		    Class85.anIntArray1563[client.anInt2382++] = i_31_;
		    class1_sub6_sub2.anInt2575 = Class68_Sub3.anInt2812;
		    ...
		    Class85.anIntArray1563[client.anInt2382++] = i_31_;
		    class1_sub6_sub2.anInt2575 = Class68_Sub3.anInt2812;
		    int i_34_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 3);
		    class1_sub6_sub2.method151(false, i_34_, (byte) 21);
		    int i_35_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
		    if (i_35_ == 1)
			PacketStream.anIntArray4110[Class68_Sub20_Sub16.anInt4418++] = i_31_;
		} else if (i_33_ == 2) {
		    Class85.anIntArray1563[client.anInt2382++] = i_31_;
		    class1_sub6_sub2.anInt2575 = Class68_Sub3.anInt2812;
		    int i_36_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 3);
		    class1_sub6_sub2.method151(true, i_36_, (byte) 21);
		    int i_37_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 3);
		    class1_sub6_sub2.method151(true, i_37_, (byte) 21);
		    int i_38_ = Class68_Sub13_Sub8.aPacketStream_3560.method967((byte) 0, 1);
