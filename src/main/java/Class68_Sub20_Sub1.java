...
public abstract class Class68_Sub20_Sub1 extends Class68_Sub20
{
	...
	for (int i_1_ = 0; i_1_ < i; i_1_++) {
	    byte i_2_ = class100.aByteArray2268[i_1_];
	    if (i_2_ == 60 || i_2_ == 62)
		i_0_ += 3;
	}
	RSString class100_3_ = new RSString();
	class100_3_.anInt2293 = i + i_0_;
	class100_3_.aByteArray2268 = new byte[class100_3_.anInt2293];
	int i_4_ = 0;
	for (int i_5_ = 0; i_5_ < i; i_5_++) {
	    byte i_6_ = class100.aByteArray2268[i_5_];
	    if (i_6_ == 60) {
		class100_3_.aByteArray2268[i_4_++] = (byte) 60;
		class100_3_.aByteArray2268[i_4_++] = (byte) 108;
		class100_3_.aByteArray2268[i_4_++] = (byte) 116;
		class100_3_.aByteArray2268[i_4_++] = (byte) 62;
	    } else if (i_6_ == 62) {
		class100_3_.aByteArray2268[i_4_++] = (byte) 60;
		class100_3_.aByteArray2268[i_4_++] = (byte) 103;
		class100_3_.aByteArray2268[i_4_++] = (byte) 116;
		class100_3_.aByteArray2268[i_4_++] = (byte) 62;
	    } else
		class100_3_.aByteArray2268[i_4_++] = i_6_;
	}
	return class100_3_;
    }
	...
	for (int i_71_ = 0; i_71_ < class100.anInt2293; i_71_++) {
	    int i_72_ = class100.aByteArray2268[i_71_] & 0xff;
	    if (i_72_ == 60)
		i_69_ = i_71_;
	    else {
		if (i_72_ == 62 && i_69_ != -1) {
	...
	for (int i_98_ = 0; i_98_ < class100.anInt2293; i_98_++) {
	    int i_99_ = class100.aByteArray2268[i_98_] & 0xff;
	    if (i_99_ == 60)
		i_95_ = i_98_;
	    else {
		if (i_99_ == 62 && i_95_ != -1) {
	...
	for (int i_128_ = 0; i_128_ < class100.anInt2293; i_128_++) {
	    int i_129_ = class100.aByteArray2268[i_128_] & 0xff;
	    if (i_129_ == 60)
		i = i_128_;
	    else {
		if (i_129_ == 62 && i != -1) {
	...
	aRSString_4143 = Class21.method339(-18982, 100);
	anInt4174 = 256;
	anInt4177 = -1;
	anInt4175 = 0;
	anInt4172 = -1;
